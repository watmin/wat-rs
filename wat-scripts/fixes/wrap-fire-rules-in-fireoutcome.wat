;; wat-scripts/fixes/wrap-fire-rules-in-fireoutcome.wat — arc 278 the FIRE-OUTCOME wall, S2b
;; (`fire-rules`, the 529-site verb — swept with the tool `fire-once` was sent first to prove).
;;
...
(:wat::core::defn :user::fire-rules-call? [node <- :wat::WatAST] -> :wat::core::bool
  (:wat::core::let [h (:user::head-kw-name node)]
    (:wat::core::if (:wat::core::= h ":wat::rete::fire-rules")
      true
      (:wat::core::= h ":wat::rete::fire-rules$oracle"))))
  ...
  (:wat::core::if (:wat::core::empty? paths)
    ...
    (:wat::core::let [path (:wat::core::first paths)]
      (:wat::core::do
        ...
        (:wat::kernel::println (:wat::core::string::concat "[wrap-fireoutcome-rules] " path))
