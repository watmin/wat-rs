    ...
    (:wat::core::fn [s <- :wat::rete::Session  n <- :fix::Node] -> :wat::rete::Session
      ...
      (:wat::core::match (:wat::rete::insert s n)
        ...
        [:wat::rete::InsertOutcome.MemoryCeilingExceeded {:limit __l :used __u :staged __c}
          (:wat::kernel::assertion-failed! :message "to-faithful-clojure: session memory ceiling exceeded while staging")]))
    session
    nodes))
          ...
          (:wat::kernel::assertion-failed! :message "to-faithful-clojure: the rule set may not terminate")])
                    ...
                    fired   (:wat::core::match (:wat::rete::fire-rules staged)
                              ...
                              [:wat::rete::FireOutcome.MemoryCeilingExceeded {:limit __l :used __u :rounds __r}
                                (:wat::kernel::assertion-failed! :message "to-faithful-clojure-rete: session memory ceiling exceeded")]
                              [:wat::rete::FireOutcome.RoundCapExceeded {:cap __c :still-deriving __s}
                                (:wat::kernel::assertion-failed! :message "to-faithful-clojure-rete: fixpoint round cap exceeded")])
