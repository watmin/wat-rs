...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:wat::core::let [s0    (:wat::rete::compile (:wat::rete::collect-rules :c))
    ...
    (:wat::core::do
      (:wat::kernel::println (:wat::core::string::concat "A (input)  = " (:wat::core::str (:wat::core::length (:wat::rete::query-by-type-string fired "c::A")))))
      (:wat::kernel::println (:wat::core::string::concat "B (derived)= " (:wat::core::str (:wat::core::length (:wat::rete::query-by-type-string fired "c::B")))))
      (:wat::kernel::println (:wat::core::string::concat "C (expect 2)= " (:wat::core::str (:wat::core::length (:wat::rete::query-by-type-string fired "c::C"))))))))
