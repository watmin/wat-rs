...
;;           [:wat::rete::InsertOutcome.MemoryCeilingExceeded {:limit __l :used __u :staged __c} (assertion-failed! :message "…")])
;;
...
(:wat::core::defn :user::wrap-edits
  ...
  (:wat::core::Vector :- [(:wat::core::Tuple :- [:wat::core::i64 :wat::core::String :wat::core::String])]
    ...
    (:wat::core::Tuple (:user::end-off node lines) ""
      " [:wat::rete::InsertOutcome.Inserted {:session __staged} __staged] [:wat::rete::InsertOutcome.MemoryCeilingExceeded {:limit __limit :used __used :staged __count} (:wat::kernel::assertion-failed! :message \"insert: session memory ceiling exceeded while staging\")])")))
