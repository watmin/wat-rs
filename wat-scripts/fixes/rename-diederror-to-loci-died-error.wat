...
(:wat::core::defn :user::migrate [src <- :wat::core::String] -> :wat::core::String
  (:wat::core::let
    [src1  (:wat::fix::rename-keyword-prefix ":wat::kernel::ThreadDiedError" ":wat::kernel::LociDiedError" src)
     ...
     lines (:wat::string::split src2 "\n")
     forms (:wat::core::ast->children (:wat::core::match (:wat::core::read-string src2) [:wat::core::ReadOutcome::Forms {:forms __forms} __forms] [:wat::core::ReadOutcome::Malformed {:cause __cause} (:wat::kernel::assertion-failed! (:wat::core::Error/message __cause) :wat::core::None :wat::core::None)]))
