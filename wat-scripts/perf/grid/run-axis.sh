...
if [ -n "${GRID_SKIP_ORACLE:-}" ]; then
  ...
  # it broke this runner from the moment the wall landed. `(FireOutcome.Fired {:value fired})` keeps
  # the match well-typed and makes it take that arm at once, which is exactly what "skip the oracle
