...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:wat::core::let [mid (:wat::core::PersistentVector (:wnn::wind-not-not-temp))
      ...
      (:wnn::n-hit
        (:wat::core::match (:wat::rete::fire-rules
          (:wat::rete::insert (:wat::rete::compile-all mid (:wat::core::PersistentVector (:wnn::q-Hit) (:wnn::q-Yes)))
            (:wnn::Wind :kph 40 :loc "MCI"))) ((:wat::rete::FireOutcome::Fired __fired) __fired) ((:wat::rete::FireOutcome::MemoryCeilingExceeded __limit __used __rounds) (:wat::kernel::assertion-failed! "fire-rules: session memory ceiling exceeded" :wat::core::None :wat::core::None)) ((:wat::rete::FireOutcome::RoundCapExceeded __cap __still) (:wat::kernel::assertion-failed! "fire-rules: fixpoint round cap exceeded" :wat::core::None :wat::core::None)))))
    (:wnn::line 2 "same-loc"
      (:wnn::n-hit
        (:wat::core::match (:wat::rete::fire-rules
          (:wat::rete::insert (:wat::rete::compile-all mid (:wat::core::PersistentVector (:wnn::q-Hit) (:wnn::q-Yes)))
            (:wnn::Wind :kph 40 :loc "MCI")
            (:wnn::Temp :c 10 :loc "MCI"))) ((:wat::rete::FireOutcome::Fired __fired) __fired) ((:wat::rete::FireOutcome::MemoryCeilingExceeded __limit __used __rounds) (:wat::kernel::assertion-failed! "fire-rules: session memory ceiling exceeded" :wat::core::None :wat::core::None)) ((:wat::rete::FireOutcome::RoundCapExceeded __cap __still) (:wat::kernel::assertion-failed! "fire-rules: fixpoint round cap exceeded" :wat::core::None :wat::core::None)))))
    (:wnn::line 3 "diff-loc"
      (:wnn::n-hit
        (:wat::core::match (:wat::rete::fire-rules
          (:wat::rete::insert (:wat::rete::compile-all mid (:wat::core::PersistentVector (:wnn::q-Hit) (:wnn::q-Yes)))
            (:wnn::Wind :kph 40 :loc "MCI")
            (:wnn::Temp :c 10 :loc "ORD"))) ((:wat::rete::FireOutcome::Fired __fired) __fired) ((:wat::rete::FireOutcome::MemoryCeilingExceeded __limit __used __rounds) (:wat::kernel::assertion-failed! "fire-rules: session memory ceiling exceeded" :wat::core::None :wat::core::None)) ((:wat::rete::FireOutcome::RoundCapExceeded __cap __still) (:wat::kernel::assertion-failed! "fire-rules: fixpoint round cap exceeded" :wat::core::None :wat::core::None)))))
    ...
    (:wnn::line 5 "lead-empty"
      (:wnn::n-yes (:wat::core::match (:wat::rete::fire-rules (:wat::rete::compile-all lead (:wat::core::PersistentVector (:wnn::q-Hit) (:wnn::q-Yes)))) ((:wat::rete::FireOutcome::Fired __fired) __fired) ((:wat::rete::FireOutcome::MemoryCeilingExceeded __limit __used __rounds) (:wat::kernel::assertion-failed! "fire-rules: session memory ceiling exceeded" :wat::core::None :wat::core::None)) ((:wat::rete::FireOutcome::RoundCapExceeded __cap __still) (:wat::kernel::assertion-failed! "fire-rules: fixpoint round cap exceeded" :wat::core::None :wat::core::None)))))
