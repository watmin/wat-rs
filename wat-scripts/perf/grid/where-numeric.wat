...
(:wat::rete::defrule :wnm::quot-neg
  :when
  [(:wnm::Num (?k <- :k) (?a <- :a) (?z <- :z) (?x <- :x) (?y <- :y)) (:wat::rete::where (:wat::rete::core::i64::< (:wat::core::i64::quot ?a 7) 0))]
  :then
  [(:wnm::Hit ?k)])
...
(:wat::rete::defrule :wnm::rem-neg
  :when
  [(:wnm::Num (?k <- :k) (?a <- :a) (?z <- :z) (?x <- :x) (?y <- :y)) (:wat::rete::where (:wat::rete::core::i64::< (:wat::core::i64::rem ?a 7) 0))]
  :then
  [(:wnm::Hit ?k)])
...
(:wat::rete::defrule :wnm::mod-negdiv
  :when
  [(:wnm::Num (?k <- :k) (?a <- :a) (?z <- :z) (?x <- :x) (?y <- :y)) (:wat::rete::where (:wat::rete::core::i64::< (:wat::core::i64::mod ?a -7) -3))]
  :then
  [(:wnm::Hit ?k)])
...
(:wat::rete::defrule :wnm::div-negdiv
  :when
  [(:wnm::Num (?k <- :k) (?a <- :a) (?z <- :z) (?x <- :x) (?y <- :y)) (:wat::rete::where (:wat::rete::core::i64::> (:wat::core::i64::/ ?a -3) 0))]
  :then
  [(:wnm::Hit ?k)])
...
(:wat::rete::defrule :wnm::fsq
  :when
  [(:wnm::Num (?k <- :k) (?a <- :a) (?z <- :z) (?x <- :x) (?y <- :y)) (:wat::rete::where (:wat::rete::core::f64::> (:wat::core::f64::* ?x ?x) 100.0))]
  :then
  [(:wnm::Hit ?k)])
...
(:wat::rete::defrule :wnm::div-by-zero
  :when
  [(:wnm::Num (?k <- :k) (?a <- :a) (?z <- :z) (?x <- :x) (?y <- :y)) (:wat::rete::where (:wat::rete::core::i64::> (:wat::core::i64::/ ?a ?z) 1))]
  :then
  [(:wnm::Hit ?k)])
