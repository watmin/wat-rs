...
(:wat::core::defn :wst::derived-ints
  ...
  (:wat::core::sort
    (:wat::core::into (:wat::core::Vector :wat::core::i64)
      (:wat::core::map
        (:wat::core::fn [p <- :wat::core::PersistentMap] -> :wat::core::i64 (:wat::core::let [f (:wat::core::Option/expect (:wat::core::PersistentMap/get p "?fact") "query: ?fact")] (:wst::Hit/k f)))
...
(:wat::core::defn :wst::run-row [row <- :wat::core::i64] -> :wat::core::String
  (:wat::core::let [rules   (:wst::build-rules row)
                    ...
                    staged  (:wst::seed (:wat::core::match (:wat::rete::compile-all rules (:wat::core::PersistentVector (:wst::q-Hit))) ((:wat::rete::CompileOutcome::Compiled __session) __session) ((:wat::rete::CompileOutcome::MayNotTerminate __rule __fact-type) (:wat::kernel::assertion-failed! "compile: the rule set may not terminate" :wat::core::None :wat::core::None))) (:wst::items))
