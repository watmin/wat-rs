...
(:wat::core::defn :wc::heavy? [v <- :wat::core::PersistentVector<wat::core::i64>] -> :wat::core::bool
  (:wat::core::and
    (:wat::core::i64::> (:wat::core::PersistentVector/length v) 2)
    (:wat::core::PersistentVector/contains? v 7)))
...
(:wat::core::defn :wc::derived-ints
  ...
  (:wat::core::sort
    (:wat::core::into (:wat::core::Vector :wat::core::i64)
      (:wat::core::map
        (:wat::core::fn [f <- :wc::Hit] -> :wat::core::i64 (:wc::Hit/k f))
        (:wat::rete::query-by-type-string fired "wc::Hit")))))
...
(:wat::core::defn :wc::run-row [row <- :wat::core::i64] -> :wat::core::String
  (:wat::core::let [rules   (:wc::build-rules row)
                    ...
                    staged  (:wc::seed (:wat::rete::compile rules) (:wc::items))
