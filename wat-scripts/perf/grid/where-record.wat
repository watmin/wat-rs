...
(:wat::core::defn :wr::is-risky? [st <- :wr::Status] -> :wat::core::bool
  (:wat::core::match st
    ((:wr::Status::Active lvl)    (:wat::core::i64::> lvl 3))
    (:wr::Status::Inactive        false)
    ((:wr::Status::Pending reason) (:wat::core::i64::> reason 1))))
...
(:wat::core::defn :wr::note-positive? [nt <- :wat::core::Option<wat::core::i64>] -> :wat::core::bool
  (:wat::core::match nt
    ((:wat::core::Some v) (:wat::core::i64::> v 2))
    (:wat::core::None     false)))
...
(:wat::core::defn :wr::derived-ints
  ...
  (:wat::core::sort
    (:wat::core::into (:wat::core::Vector :wat::core::i64)
      (:wat::core::map
        (:wat::core::fn [f <- :wr::Hit] -> :wat::core::i64 (:wr::Hit/k f))
        (:wat::rete::query-by-type-string fired "wr::Hit")))))
...
(:wat::core::defn :wr::run-row [row <- :wat::core::i64] -> :wat::core::String
  (:wat::core::let
    [rules   (:wr::build-rules row)
     ...
     staged  (:wr::seed (:wat::rete::compile rules) (:wr::items))
