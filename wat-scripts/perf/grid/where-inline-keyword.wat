...
(:wat::core::defn :wik::run-row [row <- :wat::core::i64] -> :wat::core::String
  (:wat::core::let [rules   (:wik::rules-for row)
                    staged  (:wik::seed (:wat::core::match (:wat::rete::compile-all rules (:wat::core::PersistentVector (:wik::q-Hit))) ((:wat::rete::CompileOutcome::Compiled __session) __session) ((:wat::rete::CompileOutcome::MayNotTerminate __rule __fact-type) (:wat::kernel::assertion-failed! "compile: the rule set may not terminate" :wat::core::None :wat::core::None))) (:wik::items))
