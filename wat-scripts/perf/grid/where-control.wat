...
(:wat::rete::core::defn :wsc::bump [x <- :wat::core::i64] -> :wat::core::i64 (:wat::rete::i64::+ x 1 :undefined 0))
  ...
  [(:wsc::Req (?k <- :k) (?a <- :a) (?b <- :b) (?n <- :n) (?o <- :o)) (:wat::rete::where
                                 (:wat::rete::core::if (:wat::rete::i64::= ?a 0)
                                   ...
                                   (:wat::rete::core::if (:wat::rete::i64::= ?a 1)
                                     false
                                     (:wat::rete::core::if (:wat::rete::i64::= ?a 2)
                                       true
                                       false))))]
  :then
  [(:wsc::Hit ?k)])
...
(:wat::rete::defrule :wsc::deep-nest
  ...
  [(:wsc::Req (?k <- :k) (?a <- :a) (?b <- :b) (?n <- :n) (?o <- :o)) (:wat::rete::where
                                 (:wat::rete::core::let [s (:wat::rete::i64::+ ?a ?b :undefined 3)]
                                   (:wat::rete::core::and
                                     ?n
                                     (:wat::rete::core::if (:wat::rete::i64::> s 6)
                                       true
                                       (:wat::rete::i64::< s 3)))))]
  :then
  [(:wsc::Hit ?k)])
...
(:wat::core::defn :wsc::build-rules [row <- :wat::core::i64] -> (:wat::core::PersistentVector :- [:wat::rete::Rule])
  (:wat::core::PersistentVector
    (:wat::core::cond
      ...
      (:else
        (:wat::kernel::assertion-failed! :message (:wat::string::concat "where-control: unknown row " (:wat::i64::to-string row)))))))
...
(:wat::core::defn :wsc::derived-ints
  ...
  (:wat::core::sort
    (:wat::core::into (:wat::core::Vector :- [:wat::core::i64])
      (:wat::core::map
        (:wat::core::fn [p <- :wat::core::PersistentMap] -> :wat::core::i64 (:wat::core::let [f (:wat::core::Option/expect (:wat::map::get p "?fact") "query: ?fact")] (:wsc::Hit/k f)))
...
(:wat::core::defn :wsc::run-row [row <- :wat::core::i64] -> :wat::core::String
  (:wat::core::let [rules   (:wsc::build-rules row)
                    ...
                    staged  (:wsc::seed (:wat::core::match (:wat::rete::compile-all rules (:wat::core::PersistentVector (:wsc::q-Hit))) [:wat::rete::CompileOutcome.Compiled {:session __session} __session] [:wat::rete::CompileOutcome.MayNotTerminate {:rule __rule :fact-type __fact-type} (:wat::kernel::assertion-failed! :message "compile: the rule set may not terminate")]) (:wsc::items))
