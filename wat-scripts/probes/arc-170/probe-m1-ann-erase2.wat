            ...
            [:wat::core::Some {:value p}
              (:wat::core::let
                [_  (:probe::echo/grant eh (:wat::core::Vector :- [:wat::core::i64] p))
                 ...
                 _  (:wat::core::match (:wat::kernel::send worker (:probe::PoolMsg::Setup (:wat::core::first erased))) [:wat::kernel::SendOutcome::Sent {} nil] [:wat::kernel::SendOutcome::Closed {} nil] [:wat::kernel::SendOutcome::Stopped {} nil] [:wat::kernel::SendOutcome::Lost {:cause _c} nil])
                 _  (:wat::core::match (:wat::kernel::send worker (:probe::PoolMsg::Work "z")) [:wat::kernel::SendOutcome::Sent {} nil] [:wat::kernel::SendOutcome::Closed {} nil] [:wat::kernel::SendOutcome::Stopped {} nil] [:wat::kernel::SendOutcome::Lost {:cause _c} nil])
