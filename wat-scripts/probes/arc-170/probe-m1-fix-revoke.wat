           ...
           ((:wat::core::Some p)
             (:wat::core::let
               [_  (:wat::service::require-granted (:probe::echo/grant  eh (:wat::core::Vector :- [:wat::core::i64] p)))
                ...
                _r (:wat::service::require-granted (:probe::echo/revoke eh (:wat::core::Vector :- [:wat::core::i64] p)))
                ...
                r2 (:wat::core::match rr2
                     ...
                     (:wat::kernel::RecvOutcome::Closed
                       (:wat::kernel::assertion-failed! "recv': prober closed unexpectedly" :wat::core::None :wat::core::None)) (:wat::kernel::RecvOutcome::TimedOut (:wat::kernel::assertion-failed! "recv: timed out — the peer is alive and silent" :wat::core::None :wat::core::None)) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None)))]
