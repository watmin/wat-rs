             ...
             (:wat::core::defn :probe::runner
               ...
               (:wat::core::let
                 [item (:wat::kernel::recv self)
                  _    (:wat::core::match (:wat::kernel::send self (:probe::work item)) [:wat::kernel::SendOutcome.Sent {} nil] [:wat::kernel::SendOutcome.Closed {} nil] [:wat::kernel::SendOutcome.Lost {:cause _c} nil])]
                 (:probe::runner self)))
             (:wat::core::defn :user::main [] -> :wat::core::nil
