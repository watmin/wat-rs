...
(:wat::core::defn :user::gen-digit [i <- :wat::core::i64  base <- :wat::core::i64] -> :wat::core::i64
  (:wat::i64::- i (:wat::i64::* (:wat::i64::/ i base) base)))
            ...
            (:wat::core::foldl
              (:wat::core::fn [acc <- :user::GenAcc  b <- :wat::core::i64] -> :user::GenAcc
                (:user::GenAcc
                  ...
                  :out (:wat::vector::conj (:user::GenAcc/out acc)
...
(:wat::core::defn :user::gen-check :- [T]
  ...
  (:wat::core::let [_ (:wat::core::if (:wat::core::= (:user::Gen/card g) 0)
                        (:wat::kernel::assertion-failed! :message "gen-check: the generator is EMPTY (card 0) — enumerating it applies the property to nothing and returns 0, which is indistinguishable from passing. A `gen-such-that` whose predicate excludes everything is the usual cause.")
                        0)
                    at (:user::Gen/at g)]
    (:wat::core::foldl
      (:wat::core::fn [acc <- :wat::core::i64  i <- :wat::core::i64] -> :wat::core::i64
        (:wat::i64::+ acc (prop (at i))))
      0
                    ...
                    [:wat::core::Option.None {}
                      (:wat::core::if (:wat::core::< (:user::Pick/rest acc) (:user::Gen/card g))
                        (:user::Pick :rest (:user::Pick/rest acc)
                                     :got (:wat::core::Option.Some {:value ((:user::Gen/at g) (:user::Pick/rest acc))}))
                        (:user::Pick :rest (:wat::i64::- (:user::Pick/rest acc) (:user::Gen/card g))
                                     :got :wat::core::Option.None))]))
                (:user::Pick :rest i :got :wat::core::Option.None)
                gs))
...
(:wat::core::defn :user::gen-lift2 :- [A B R]
  ...
  (:wat::core::let [ca (:user::Gen/card ga)
                    fa (:user::Gen/at ga)
                    fb (:user::Gen/at gb)]
    (:user::Gen :card (:wat::i64::* ca (:user::Gen/card gb))
...
(:wat::core::defn :user::gen-lift3 :- [A B C R]
  ...
  (:wat::core::let [ca (:user::Gen/card ga)
                    ...
                    fb (:user::Gen/at gb)
                    fc (:user::Gen/at gc)]
    (:user::Gen :card (:wat::i64::* (:wat::i64::* ca cb) (:user::Gen/card gc))
                :at (:wat::core::fn [i <- :wat::core::i64] -> R
