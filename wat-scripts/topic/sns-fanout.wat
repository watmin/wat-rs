       ...
       (:wat::core::match sr
         ...
         (:wat::kernel::RecvOutcome::TimedOut
           (:wat::core::let
             ...
             (:wat::service::Outcome::Continue s'
               (:wat::core::Some (:demo::Topic::Reply::Publish (:demo::Topic::PublishResponse::Accepted 0)))
               sends none-alarms))) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None)))))
