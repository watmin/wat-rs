...
;; ── the ONLY delta from tests/services/probe_arc209_c0b3aii_process_service_loop.wat ──
;; N round trips instead of one, so the spawn cost amortises and the poll loop dominates.
(:wat::core::defn :user::trip
  [c <- (:wat::kernel::Peer :- [:wat::core::i64 :wat::core::i64])]
  -> :wat::core::i64
  (:wat::core::let
    [_ (:wat::core::match (:wat::kernel::send c 5) (:wat::kernel::SendOutcome::Sent nil) (:wat::kernel::SendOutcome::Closed nil) (:wat::kernel::SendOutcome::Stopped nil) ((:wat::kernel::SendOutcome::Lost _c) nil))]
    (:wat::core::match (:wat::kernel::recv c)
      ((:wat::kernel::RecvOutcome::Message m) m)
      ((:wat::kernel::RecvOutcome::Lost cause)
        (:wat::kernel::assertion-failed! (:wat::kernel::LociDiedError/message cause) :wat::core::None :wat::core::None))
      (:wat::kernel::RecvOutcome::Stopped
        (:wat::kernel::assertion-failed! "bench: stopped" :wat::core::None :wat::core::None))
      (:wat::kernel::RecvOutcome::Closed
        (:wat::kernel::assertion-failed! "bench: closed" :wat::core::None :wat::core::None))
      (:wat::kernel::RecvOutcome::TimedOut
        (:wat::kernel::assertion-failed! "bench: timed out" :wat::core::None :wat::core::None))
      ((:wat::kernel::RecvOutcome::Malformed _cause)
        (:wat::kernel::assertion-failed! "bench: malformed" :wat::core::None :wat::core::None)))))

(:wat::core::defn :user::trips
  [c   <- (:wat::kernel::Peer :- [:wat::core::i64 :wat::core::i64])
   n   <- :wat::core::i64
   acc <- :wat::core::i64]
  -> :wat::core::i64
  (:wat::core::if (:wat::core::= n 0)
    acc
    (:user::trips c (:wat::core::- n 1) (:wat::core::+ acc (:user::trip c)))))
