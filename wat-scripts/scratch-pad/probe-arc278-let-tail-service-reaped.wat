...
(:wat::service::defservice :tl::bag-svc
  ...
  :impls
  [(put [s ctx req] (:wat::service::Outcome::Continue s (:wat::core::Some (:tl::Bag::Reply::Put (:tl::Bag::PutResponse::Ok 1))) (:wat::core::Vector :- [(:wat::service::Directed :- [:tl::Bag::Reply])]) (:wat::core::Vector :- [(:wat::service::Alarm :- [:tl::bag-svc::Op])])))])
