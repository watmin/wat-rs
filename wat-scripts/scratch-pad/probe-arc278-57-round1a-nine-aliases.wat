...
(def :probe-string-length (:wat::rete::core::string::length "abc"))
(def :probe-string-trim (:wat::rete::core::string::trim "  abc  "))
(def :probe-string-to-lowercase (:wat::rete::core::string::to-lowercase "ABC"))
