...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:wat::core::do
    (:wat::core::let [rules (:wat::core::PersistentVector (:usr::suspect) (:usr::anomaly))
                      template (:wat::core::match (:wat::rete::compile-all rules (:wat::core::PersistentVector (:usr::q-Suspect) (:usr::q-Anomaly))) [:wat::rete::CompileOutcome.Compiled {:session __session} __session] [:wat::rete::CompileOutcome.MayNotTerminate {:rule __rule :fact-type __fact-type} (:wat::kernel::assertion-failed! :message "compile: the rule set may not terminate")])]
      (:wat::core::do
