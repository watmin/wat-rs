    ...
    (:wat::core::match r
      [:wat::kernel::RecvOutcome::Message {:msg resp}
        (:wat::core::match resp
          ...
          [:wat::cache::Cache::GetResponse::RequestTooLarge {:bytes bytes :cap cap} (:wat::kernel::assertion-failed! "ROW3: RequestTooLarge" :wat::core::None :wat::core::None)]
          [:wat::cache::Cache::GetResponse::RequestMalformed {:path p :expected e :got g} (:wat::kernel::assertion-failed! "ROW3: RequestMalformed" :wat::core::None :wat::core::None)])]
      [:wat::kernel::RecvOutcome::Lost {:cause cause} (:wat::kernel::assertion-failed! (:wat::kernel::LociDiedError/message cause) :wat::core::None :wat::core::None)]
