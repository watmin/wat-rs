...
(:wat::core::defn :arena::fire-one [template <- :wat::rete::Session seed <- :arena::Event] -> :wat::core::String
  (:wat::core::let
    ...
    (:wat::string::concat "Su=" (:wat::string::concat (:wat::core::str su)
      (:wat::string::concat " Fl=" (:wat::string::concat (:wat::core::str fl)
        (:wat::string::concat " An=" (:wat::string::concat (:wat::core::str an)
          (:wat::string::concat " Br=" (:wat::string::concat (:wat::core::str br)
            (:wat::string::concat " Ov=" (:wat::string::concat (:wat::core::str ov)
              (:wat::string::concat " Cr=" (:wat::string::concat (:wat::core::str cr)
                (:wat::string::concat " TOTAL=" (:wat::core::str total))))))))))))))))
...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:wat::core::let
    [rules (:wat::core::PersistentVector
     ...
     template (:wat::core::match (:wat::rete::compile-all rules (:wat::core::PersistentVector (:arena::q-Suspect) (:arena::q-Flagged) (:arena::q-Anomaly) (:arena::q-Breach) (:arena::q-Overflow) (:arena::q-Critical))) [:wat::rete::CompileOutcome.Compiled {:session __session} __session] [:wat::rete::CompileOutcome.MayNotTerminate {:rule __rule :fact-type __fact-type} (:wat::kernel::assertion-failed! :message "compile: the rule set may not terminate")])]
    (:wat::core::do
