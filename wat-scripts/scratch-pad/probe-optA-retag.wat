...
(:wat::core::defn :probe-retag::serve-thread
  ...
  (:wat::core::match (:wat::kernel::poll' self l selectables) -> :wat::core::nil
    ...
    ((:wat::spawn::ServiceEvent::Closed idx)
      (:probe-retag::serve-thread self l (:wat::std::list::remove-at selectables idx) saw-tick client-idx))
            ...
            (:wat::core::forms
              ...
              (:wat::core::defn :probe-retag::serve-proc
                ...
                (:wat::core::match (:wat::kernel::poll' self l selectables) -> :wat::core::nil
                  ...
                  ((:wat::spawn::ServiceEvent::Closed idx)
                    (:probe-retag::serve-proc self l (:wat::std::list::remove-at selectables idx) saw-tick client-idx))
                  ((:wat::spawn::ServiceEvent::Lost idx _cause)
                    (:probe-retag::serve-proc self l (:wat::std::list::remove-at selectables idx) saw-tick client-idx))
                  ((:wat::spawn::ServiceEvent::Malformed idx _cause)
...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:wat::core::do
    (:wat::core::match (:probe-retag::thread-mix) -> :wat::core::nil
    ...
    (:wat::core::match (:probe-retag::process-mix) -> :wat::core::nil
