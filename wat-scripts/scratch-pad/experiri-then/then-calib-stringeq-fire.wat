;; experiri (vigilia cast, 2026-09-08) — `:then` value-operand position, CALIBRATION cell 3/4.
;; Fire-drive for :wat::rete::core::string::= — hit="alpha" (matches), miss="beta" (does not).
;; Expect: 1.
