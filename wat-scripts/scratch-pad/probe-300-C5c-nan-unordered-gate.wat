...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:wat::kernel::println
    (:wat::core::PersistentMap
      ...
      ;; row 2/3 — the defect
      :row2-le-1-nan   (:wat::core::<= 1 (:wat::f64::/ 0.0 0.0))
      :row3-ge-1-nan   (:wat::core::>= 1 (:wat::f64::/ 0.0 0.0))
      ;; row 5 — NaN on the LEFT, all four ops
      :row5-lt-nan-1   (:wat::core::< (:wat::f64::/ 0.0 0.0) 1)
      :row5-le-nan-1   (:wat::core::<= (:wat::f64::/ 0.0 0.0) 1)
      :row5-gt-nan-1   (:wat::core::> (:wat::f64::/ 0.0 0.0) 1)
      :row5-ge-nan-1   (:wat::core::>= (:wat::f64::/ 0.0 0.0) 1)
      ;; row 6 — NaN vs NaN
      :row6-lt-nan-nan (:wat::core::< (:wat::f64::/ 0.0 0.0) (:wat::f64::/ 0.0 0.0))
      :row6-le-nan-nan (:wat::core::<= (:wat::f64::/ 0.0 0.0) (:wat::f64::/ 0.0 0.0))
      ;; row 7 — = / not= untouched (IEEE exception)
      :row7-noteq      (:wat::core::not= 1 (:wat::f64::/ 0.0 0.0))
      :row7-eq         (:wat::core::= 1 (:wat::f64::/ 0.0 0.0))
      ;; row 8 — Inf unchanged
      :row8-lt-inf     (:wat::core::< 1 (:wat::f64::/ 1.0 0.0))
      :row8-le-inf     (:wat::core::<= 1 (:wat::f64::/ 1.0 0.0))
      ...
      :row11-f64-le    (:wat::f64::<= 1.0 (:wat::f64::/ 0.0 0.0))
      :row11-f64-ge    (:wat::f64::>= 1.0 (:wat::f64::/ 0.0 0.0))
      )))
