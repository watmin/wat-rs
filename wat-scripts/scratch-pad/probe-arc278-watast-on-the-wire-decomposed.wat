...
(:wat::core::defn :probe::run-echo [] -> :wat::core::nil
  (:wat::core::let
    ...
    (:wat::core::match (:probe::WireKind/echo c (:probe::WireKind::EchoRequest :n 7))
      ...
      (:wat::kernel::RecvOutcome::Closed  (:wat::kernel::println "CONTROL echo(i64)        => CLOSED")) (:wat::kernel::RecvOutcome::TimedOut (:wat::kernel::assertion-failed! "recv: timed out — the peer is alive and silent" :wat::core::None :wat::core::None)) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None)))))
...
(:wat::core::defn :probe::run-count [] -> :wat::core::nil
  (:wat::core::let
    ...
    (:wat::core::match (:probe::WireKind/count c (:probe::WireKind::CountRequest :defs (:probe::three-forms)))
      ...
      (:wat::kernel::RecvOutcome::Closed  (:wat::kernel::println "SUBJECT count(Vec<WatAST>) => CLOSED")) (:wat::kernel::RecvOutcome::TimedOut (:wat::kernel::assertion-failed! "recv: timed out — the peer is alive and silent" :wat::core::None :wat::core::None)) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None)))))
...
(:wat::core::defn :probe::run-count-thread [] -> :wat::core::nil
  (:wat::core::let
    ...
    (:wat::core::match (:probe::WireKind/count c (:probe::WireKind::CountRequest :defs (:probe::three-forms)))
      ...
      (:wat::kernel::RecvOutcome::Closed  (:wat::kernel::println "ISOLATOR count THREAD      => CLOSED")) (:wat::kernel::RecvOutcome::TimedOut (:wat::kernel::assertion-failed! "recv: timed out — the peer is alive and silent" :wat::core::None :wat::core::None)) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None)))))
