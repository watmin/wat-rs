...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:wat::core::do
    ...
    (:wat::kernel::println
      (:wat::core::string::join "," (:wat::core::into [] (:wat::core::interpose 0 (:wat::core::Vector :wat::core::i64 1)))))
    (:wat::kernel::println
      (:wat::core::string::join "," (:wat::core::into [] (:wat::core::interpose 0 (:wat::core::Vector :wat::core::i64)))))
