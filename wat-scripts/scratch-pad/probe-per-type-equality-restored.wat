...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:wat::core::do
    ...
    (:wat::kernel::println (:wat::string::concat "f64::= 1.5 1.5    -> " (:wat::core::bool::to-string (:wat::f64::= 1.5 1.5))))
    (:wat::kernel::println (:wat::string::concat "f64::= 0.0 1.0    -> " (:wat::core::bool::to-string (:wat::f64::= 0.0 1.0))))
