        ...
        poisoned (:wat::core::if hit?
                    (:wat::core::match (:cr::Sink/ping old (:cr::Sink::PingRequest :pad pad))
                      ...
                      (:wat::kernel::RecvOutcome::Stopped
                        (:wat::kernel::assertion-failed! "cr: poison stopped" :wat::core::None :wat::core::None)) (:wat::kernel::RecvOutcome::TimedOut "lost") ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None)))
                    "miss")
...
(:wat::core::defn :cr::nap [ms <- :wat::core::i64] -> :wat::core::nil
  (:wat::core::match (:wat::kernel::recv
    ...
    (:wat::kernel::RecvOutcome::Closed
      (:wat::kernel::assertion-failed! "cr: nap closed" :wat::core::None :wat::core::None)) (:wat::kernel::RecvOutcome::TimedOut (:wat::kernel::assertion-failed! "recv: timed out — the peer is alive and silent" :wat::core::None :wat::core::None)) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None))))
  ...
  (:wat::core::let
    [sh (:cr::sink/start :locus (:wat::spawn::process) :record (:cr::sink::Record :seen 0))
     ...
     _ (:wat::core::match (:cr::Front/start f (:cr::Front::StartRequest))
         ...
         (:wat::kernel::RecvOutcome::Closed
           (:wat::kernel::assertion-failed! "cr: start closed" :wat::core::None :wat::core::None)) (:wat::kernel::RecvOutcome::TimedOut (:wat::kernel::assertion-failed! "recv: timed out — the peer is alive and silent" :wat::core::None :wat::core::None)) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None)))]
