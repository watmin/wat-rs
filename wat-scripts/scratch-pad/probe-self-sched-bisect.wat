...
(:wat::core::defn :sched::poll-reason
  ...
  (:wat::core::match (:sched::Ticker/poll c (:sched::Ticker::PollRequest))
    ...
    (:wat::kernel::RecvOutcome::Closed "Closed (MUTE — the reason was dropped)") (:wat::kernel::RecvOutcome::TimedOut (:wat::kernel::assertion-failed! "recv: timed out — the peer is alive and silent" :wat::core::None :wat::core::None)) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None))))
