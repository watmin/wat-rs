;; PROBE for the latency injector — can we CONSTRUCT the desync the corpus already reasons about?
;;
...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:wat::core::let
    [h (:slow::svc/start :locus (:wat::spawn::process) :record (:slow::svc::Record :delay-ms 600))
