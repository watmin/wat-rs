;; accepted-is-a-count — after a put whose reply died, Accepted n is the
;; store's true count (intersection), not the retry sentinel 0.
;;
;; Rig: wat-scripts/query/faulting-store.wat drop-reply-bp / die-bp.
;; Run:
;;   ./target/release/wat wat-scripts/scratch-pad/probe-accepted-is-a-count.wat
