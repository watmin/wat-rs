...
(:wat::core::defn :m::seed [s <- :wat::rete::Session] -> :wat::rete::Session
  (:wat::core::match (:wat::rete::insert-all s
    (:wat::core::PersistentVector
      ...
      (:m::Member :id 5 :prefix "Vector" :base "get"       :style "slash"))) [:wat::rete::InsertOutcome.Inserted {:session __staged} __staged] [:wat::rete::InsertOutcome.MemoryCeilingExceeded {:limit __limit :used __used :staged __count} (:wat::kernel::assertion-failed! :message "insert: session memory ceiling exceeded while staging")]))
  ...
  (:wat::core::let
    [rules (:wat::core::PersistentVector
     ...
     fired (:wat::core::match (:wat::rete::fire-rules
             (:m::seed-rulings (:m::seed (:wat::rete::compile-all rules (:wat::core::PersistentVector (:m::q-Concept) (:m::q-StyleSeen) (:m::q-Settled) (:m::q-TargetNS) (:m::q-Target) (:m::q-Inconsistent) (:m::q-NoRuling)))))) [:wat::rete::FireOutcome.Fired {:value __fired} __fired] [:wat::rete::FireOutcome.MemoryCeilingExceeded {:limit __limit :used __used :rounds __rounds} (:wat::kernel::assertion-failed! :message "fire-rules: session memory ceiling exceeded")] [:wat::rete::FireOutcome.RoundCapExceeded {:cap __cap :still-deriving __still} (:wat::kernel::assertion-failed! :message "fire-rules: fixpoint round cap exceeded")])]
    (:wat::core::do
