...
(:wat::core::defn :probe::try [label <- :wat::core::String  src <- :wat::core::String] -> :wat::core::nil
  (:wat::core::do
    ...
    (:wat::kernel::println
      (:wat::eval-ast! (:wat::core::first (:wat::core::match (:wat::core::read-string src) [:wat::core::ReadOutcome::Forms {:forms __forms} __forms] [:wat::core::ReadOutcome::Malformed {:cause __cause} (:wat::kernel::assertion-failed! (:wat::core::Error/message __cause) :wat::core::None :wat::core::None)]))))))
