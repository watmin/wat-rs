;; wat-scripts/scratch-pad/probe-inline-alpha-beats-trailing-where.wat — excursus-001: the topic forgets its
;; subscriber count.
;;
...
;; ⚠ PROBE, not a migration. Mechanically generated from
;; wat-scripts/fixes/topic-record-drop-nsubs.wat with ONE change: every selective
;; constraint moved INLINE into the pattern binding its var, instead of a trailing
;; (:wat::rete::where ...). An inline constraint naming only THIS condition's bindings is
;; ALPHA (src/rete/matcher.rs:304) and filters at fact entry; a standalone `where` is a
;; beta TestNode over TOKENS (src/rete/where_tree.rs) and filters AFTER the joins. Three
;; Node patterns sharing one ?parent therefore materialise C^3 tuples first.
;;
;; ── finder ───────────────────────────────────────────────────────────────────
...
(:wat::rete::defrule :tni::token-nsubs-symbol
...
(:wat::rete::defrule :tni::record-kwarg-nsubs
...
(:wat::rete::defrule :tni::record-accessor-nsubs
  :when [(:wat::grep::Node   (?id <- :id) (?k <- :kind) (:wat::rete::string::= ?k "keyword"))
         (:wat::grep::Named  (?id <- :id) (?n <- :name) (:wat::rete::string::= ?n ":demo::topic::Record/nsubs"))
         (:wat::grep::Span   (?id <- :id) (?l <- :line) (?c <- :col) (?el <- :end-line) (?ec <- :end-col))
         (:wat::grep::Source (?f <- :file))]
  :then [(:wat::grep::Match :file ?f :line ?l :col ?c :end-line ?el :end-col ?ec
           :rule "i-record-accessor-nsubs"
           :captures (:wat::rete::core::PersistentVector
                       (:wat::grep::Capture :name "old" :value ?n)))])
...
;; therefore lives in the APPLIER (`:tni::defservice-edits`), which is stricter than this rule:
...
(:wat::rete::defrule :tni::durable-binder-nsubs
  ...
  :then [(:wat::grep::Match :file ?f :line ?l :col ?c :end-line ?el :end-col ?ec
           :rule "i-durable-binder-nsubs"
           :captures (:wat::rete::core::PersistentVector
                       (:wat::grep::Capture :name "old" :value ?n)))])

(:wat::core::defn :user::grep [] -> (:wat::core::PersistentVector :- [:wat::rete::Rule])
  (:wat::rete::collect-rules :tni))

;; ── applier ──────────────────────────────────────────────────────────────────

(:wat::core::defn :tni::empty-edits []
  -> (:wat::core::Vector :- [(:wat::core::Tuple :- [:wat::core::i64 :wat::core::String :wat::core::String])])
  (:wat::core::Vector :- [(:wat::core::Tuple :- [:wat::core::i64 :wat::core::String :wat::core::String])]))

(:wat::core::defn :tni::kw-name [n <- :wat::WatAST] -> :wat::core::String
  (:wat::core::if (:wat::core::= (:wat::core::ast-kind n) "keyword")
    (:wat::core::ast-name n) ""))

(:wat::core::defn :tni::sym-name [n <- :wat::WatAST] -> :wat::core::String
...
(:wat::core::defn :tni::record-kwarg-edits
  ...
  (:wat::core::foldl
    (:wat::core::fn [acc <- (:wat::core::Vector :- [(:wat::core::Tuple :- [:wat::core::i64 :wat::core::String :wat::core::String])])
      ...
      -> (:wat::core::Vector :- [(:wat::core::Tuple :- [:wat::core::i64 :wat::core::String :wat::core::String])])
      (:wat::core::if
        (:wat::core::if (:wat::core::= (:tni::kw-name (:wat::core::nth ch i)) ":nsubs")
...
;; and is left alone.
(:wat::core::defn :tni::durable-vec-edits
  ...
  (:wat::core::foldl
    (:wat::core::fn [acc <- (:wat::core::Vector :- [(:wat::core::Tuple :- [:wat::core::i64 :wat::core::String :wat::core::String])])
      ...
      -> (:wat::core::Vector :- [(:wat::core::Tuple :- [:wat::core::i64 :wat::core::String :wat::core::String])])
      (:wat::core::if
        (:wat::core::if (:wat::core::= (:tni::sym-name (:wat::core::nth vch i)) "nsubs")
          (:wat::core::if (:wat::core::< (:wat::core::+ i 2) (:wat::core::length vch))
            (:wat::core::= (:tni::sym-name (:wat::core::nth vch (:wat::core::+ i 1))) "<-")
            false)
          false)
        (:wat::core::concat acc
          (:tni::cut
...
(:wat::core::defn :tni::topic-defservice?
  [ch <- (:wat::core::Vector :- [:wat::WatAST])] -> :wat::core::bool
  (:wat::core::if (:wat::core::< (:wat::core::length ch) 2)
    false
    (:wat::core::if (:wat::core::= (:tni::kw-name (:wat::core::first ch)) ":wat::service::defservice")
      (:wat::core::= (:tni::kw-name (:wat::core::nth ch 1)) ":demo::topic")
      false)))

;; the vector that DIRECTLY follows `:durable` in the defservice form — not `:ephemeral`'s,
;; not `:peers`'s.
(:wat::core::defn :tni::defservice-edits
  [ch    <- (:wat::core::Vector :- [:wat::WatAST])
   lines <- (:wat::core::Vector :- [:wat::core::String])
   src   <- :wat::core::String]
  -> (:wat::core::Vector :- [(:wat::core::Tuple :- [:wat::core::i64 :wat::core::String :wat::core::String])])
  (:wat::core::foldl
    (:wat::core::fn [acc <- (:wat::core::Vector :- [(:wat::core::Tuple :- [:wat::core::i64 :wat::core::String :wat::core::String])])
      ...
      -> (:wat::core::Vector :- [(:wat::core::Tuple :- [:wat::core::i64 :wat::core::String :wat::core::String])])
      (:wat::core::if
        (:wat::core::if (:wat::core::= (:tni::kw-name (:wat::core::nth ch i)) ":durable")
          (:wat::core::< (:wat::core::+ i 1) (:wat::core::length ch))
          false)
        (:wat::core::let [v (:wat::core::nth ch (:wat::core::+ i 1))]
          (:wat::core::if (:wat::core::= (:wat::core::ast-kind v) "vector")
            (:wat::core::concat acc (:tni::durable-vec-edits (:wat::core::ast->children v) lines src))
            acc))
        acc))
    (:tni::empty-edits)
    (:wat::core::range 0 (:wat::core::length ch))))

(:wat::core::defn :tni::node-edits
  [node  <- :wat::WatAST
   lines <- (:wat::core::Vector :- [:wat::core::String])
   src   <- :wat::core::String]
  -> (:wat::core::Vector :- [(:wat::core::Tuple :- [:wat::core::i64 :wat::core::String :wat::core::String])])
    ...
    (:wat::core::let [ch   (:wat::core::ast->children node)
                      here (:wat::core::if (:wat::core::= (:wat::core::ast-kind node) "list")
                             (:wat::core::if (:wat::core::empty? ch)
                               (:tni::empty-edits)
                               (:wat::core::if (:wat::core::= (:tni::kw-name (:wat::core::first ch)) ":demo::topic::Record")
                                 (:tni::record-kwarg-edits ch lines src)
                                 (:wat::core::if (:tni::topic-defservice? ch)
                                   (:tni::defservice-edits ch lines src)
                                   (:tni::empty-edits))))
                             (:tni::empty-edits))]
      (:wat::core::concat here (:tni::seq-edits ch lines src)))
    (:tni::empty-edits)))

(:wat::core::defn :tni::seq-edits
  ...
  (:wat::core::foldl
    (:wat::core::fn [acc <- (:wat::core::Vector :- [(:wat::core::Tuple :- [:wat::core::i64 :wat::core::String :wat::core::String])])
                     it  <- :wat::WatAST]
      -> (:wat::core::Vector :- [(:wat::core::Tuple :- [:wat::core::i64 :wat::core::String :wat::core::String])])
      (:wat::core::concat acc (:tni::node-edits it lines src)))
    (:tni::empty-edits)
    items))
...
(:wat::core::defn :user::migrate [src <- :wat::core::String] -> :wat::core::String
  (:wat::core::let
    [lines (:wat::string::split src "\n")
     ...
     eds   (:tni::seq-edits forms lines src)
  ...
  (:wat::core::if (:wat::core::empty? paths)
    ...
    (:wat::core::let [path (:wat::core::first paths)]
      (:wat::core::do
        ...
        (:tni::apply-each (:wat::core::into [] (:wat::core::rest paths)))))))
