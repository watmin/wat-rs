...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:wat::core::let
    [colon (:wat::core::match (:wat::core::read-string "(:wat::core::> n 3)") [:wat::core::ReadOutcome::Forms {:forms __forms} __forms] [:wat::core::ReadOutcome::Malformed {:cause __cause} (:wat::kernel::assertion-failed! (:wat::core::Error/message __cause) :wat::core::None :wat::core::None)])
     dot   (:wat::core::match (:wat::core::read-string "(:wat.core/> n 3)") [:wat::core::ReadOutcome::Forms {:forms __forms} __forms] [:wat::core::ReadOutcome::Malformed {:cause __cause} (:wat::kernel::assertion-failed! (:wat::core::Error/message __cause) :wat::core::None :wat::core::None)])
