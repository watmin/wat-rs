...
(:wat::core::defn :user::law-record [c <- (:wat::core::PersistentVector :- [:wat::core::i64])]
  ...
  (:wat::core::let [i (:user::at0 c 0)
                    ...
                    eb (:wat::i64::+ 10 (:user::gen-digit (:user::gen-shift i 3) 2))]
    (:wat::core::if
    ...
    (:wat::core::if
      (:wat::core::and (:wat::core::= (:user::Gen/card empty) 0)
        (:wat::core::and (:wat::core::= (:user::Gen/card g) 2)
                         (:wat::core::= ((:user::Gen/at g) i) (:wat::i64::+ 7 i))))
      0 1)))
...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:wat::core::let [seven  (:user::gen-coords (:wat::core::PersistentVector 7))
                    ...
                    bad (:wat::i64::+
                          ...
                          (:wat::i64::+ b6 (:wat::i64::+ b7 (:wat::i64::+ b8 (:wat::i64::+ b9 (:wat::i64::+ b10 (:wat::i64::+ b11 (:wat::i64::+ (:wat::i64::+ b12 b13) (:wat::i64::+ b14 b15)))))))))]
    (:wat::kernel::println
      (:wat::string::concat
        (:wat::string::concat "laws=15 checked=" (:wat::i64::to-string
          (:wat::i64::+ 7 (:wat::i64::+ 7 (:wat::i64::+ 120 (:wat::i64::+ 120 (:wat::i64::+ 1 (:wat::i64::+ 4 (:wat::i64::+ 5 (:wat::i64::+ 8 (:wat::i64::+ 6 (:wat::i64::+ 6 (:wat::i64::+ 12 20)))))))))))))
