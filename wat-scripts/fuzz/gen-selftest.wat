...
(:wat::core::defn :user::violations [o <- :wat::gen::CheckOutcome] -> :wat::core::i64
  (:wat::core::match o
    [:wat::gen::CheckOutcome.Checked {:points pts :violations v} v]
...
(:wat::core::defn :user::law-ints [c <- (:wat::core::PersistentVector :- [:wat::core::i64])]
  ...
  (:wat::core::let [i  (:user::at0 c 0)
                    g  (:wat::gen::ints 5 12)
                    at (:wat::gen::Gen/at g)]
    (:wat::core::if (:wat::core::= (at i) (:wat::i64::+ 5 i)) 0 1)))
  ...
  (:wat::core::let [i  (:user::at0 c 0)
                    ...
                    r  (:wat::core::foldl
                         (:wat::core::fn [acc <- :user::Recon  b <- :wat::core::i64] -> :user::Recon
                           (:user::Recon
                             :idx (:wat::i64::+ (:user::Recon/idx acc)
                                    (:wat::i64::* (:user::at0 d (:user::Recon/n acc))
                                                        (:user::Recon/place acc)))
                             :place (:wat::i64::* (:user::Recon/place acc) b)
                             :n (:wat::i64::+ (:user::Recon/n acc) 1)))
...
(:wat::core::defn :user::law-record [c <- (:wat::core::PersistentVector :- [:wat::core::i64])]
  ...
  (:wat::core::let [i (:user::at0 c 0)
                    ...
                    eb (:wat::i64::+ 10 (:wat::gen::digit (:wat::gen::shift i 3) 2))]
    (:wat::core::if
...
(:wat::core::defn :user::law-lift3 [c <- (:wat::core::PersistentVector :- [:wat::core::i64])]
  ...
  (:wat::core::let [i (:user::at0 c 0)
                    ...
                    eb (:wat::i64::+ 10 (:wat::gen::digit (:wat::gen::shift i 2) 3))
                    ec (:wat::i64::+ 100 (:wat::gen::shift (:wat::gen::shift i 2) 3))]
    (:wat::core::if
      (:wat::core::and
...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:wat::core::let [seven  (:wat::gen::coords (:wat::core::PersistentVector 7))
                    ...
                    bad (:wat::i64::+
                          ...
                          (:wat::i64::+ b6 (:wat::i64::+ b7 (:wat::i64::+ b8 (:wat::i64::+ b9 (:wat::i64::+ b10 (:wat::i64::+ b11 (:wat::i64::+ (:wat::i64::+ b12 b13) (:wat::i64::+ b14 (:wat::i64::+ b15 (:wat::i64::+ b16 (:wat::i64::+ b17 b18))))))))))))]
    (:wat::kernel::println
      (:wat::string::concat
        (:wat::string::concat "laws=19 checked=" (:wat::i64::to-string
          (:wat::i64::+ 7 (:wat::i64::+ 7 (:wat::i64::+ 120 (:wat::i64::+ 120 (:wat::i64::+ 1 (:wat::i64::+ 4 (:wat::i64::+ 5 (:wat::i64::+ 8 (:wat::i64::+ 6 (:wat::i64::+ 6 (:wat::i64::+ 12 (:wat::i64::+ 20 (:wat::i64::+ 3 6)))))))))))))))
