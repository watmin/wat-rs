...
//! trusted door (`edn::render::decode_trusted_wire`) — handed over a lineage channel, never forged from
//! parsed data. `edn::render` owns the EDN read/write dispatch + that door and DELEGATES here; this home
