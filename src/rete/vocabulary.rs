...
//
// rune:lint(cited-name-absent) eval_vocabulary_admitted_predicate — deleted at arc 255 Stone P6-c-W5a; the dispatch now lives as a #[wat_intrinsic] handler in src/intrinsic/rete.rs calling rete_vocabulary_admitted directly.
