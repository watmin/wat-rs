    ...
    let fired = ev(
            "(:wat::core::let \
               [rules   (:wat::rete::collect-rules :weather)\
                s0      (:wat::core::match (:wat::rete::compile rules) [:wat::rete::CompileOutcome.Compiled {:session __session} __session] [:wat::rete::CompileOutcome.MayNotTerminate {:rule __rule :fact-type __ft} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")])\
                s1      (:wat::core::match (:wat::rete::insert s0 (:weather::Temperature :celsius 15 :location \"Oslo\")) [:wat::rete::InsertOutcome.Inserted {:session __staged} __staged] [:wat::rete::InsertOutcome.MemoryCeilingExceeded {:limit __ilimit :used __iused :staged __icount} (:wat::kernel::assertion-failed! :message \"insert: session memory ceiling exceeded while staging\")])\
...
fn round_trip_empty_session() {
    let compiled = ev("(:wat::core::match (:wat::rete::compile (:wat::rete::collect-rules :weather)) [:wat::rete::CompileOutcome.Compiled {:session __session} __session] [:wat::rete::CompileOutcome.MayNotTerminate {:rule __rule :fact-type __ft} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")])");
...
fn node_share_census(n: i64, m: i64) -> Vec<super::RoundCensus> {
    ...
    let src = format!(
        "(:wat::core::match (:wat::rete::fire-rules (:nsh::seed (:wat::core::match (:wat::rete::compile (:nsh::build-rules {n})) [:wat::rete::CompileOutcome.Compiled {{:session __session}} __session] [:wat::rete::CompileOutcome.MayNotTerminate {{:rule __rule :fact-type __ft}} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")]) {m})) [:wat::rete::FireOutcome.Fired {{:value __fired}} __fired] [:wat::rete::FireOutcome.MemoryCeilingExceeded {{:limit __limit :used __used :rounds __rounds}} (:wat::kernel::assertion-failed! :message \"fire-rules: session memory ceiling exceeded\")] [:wat::rete::FireOutcome.RoundCapExceeded {{:cap __cap :still-deriving __still}} (:wat::kernel::assertion-failed! :message \"fire-rules: fixpoint round cap exceeded\")])"
    );
...
fn accum_gather_visits(g: i64, w: i64) -> u64 {
    ...
    let src = format!(
            "(:wat::core::match (:wat::rete::fire-rules (:agc::seed (:wat::core::match (:wat::rete::compile (:wat::rete::collect-rules :agc)) [:wat::rete::CompileOutcome.Compiled {{:session __session}} __session] [:wat::rete::CompileOutcome.MayNotTerminate {{:rule __rule :fact-type __ft}} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")]) {g} {w})) [:wat::rete::FireOutcome.Fired {{:value __fired}} __fired] [:wat::rete::FireOutcome.MemoryCeilingExceeded {{:limit __limit :used __used :rounds __rounds}} (:wat::kernel::assertion-failed! :message \"fire-rules: session memory ceiling exceeded\")] [:wat::rete::FireOutcome.RoundCapExceeded {{:cap __cap :still-deriving __still}} (:wat::kernel::assertion-failed! :message \"fire-rules: fixpoint round cap exceeded\")])"
        );
    let ast = crate::parse_one!(src.as_str()).expect("parse the fire driver");
...
fn accum_phase_census(g: i64, w: i64) -> Vec<(&'static str, u64, u64)> {
    ...
    let staged =
        format!("(:apx::seed (:wat::core::match (:wat::rete::compile (:wat::rete::collect-rules :apx)) [:wat::rete::CompileOutcome.Compiled {{:session __session}} __session] [:wat::rete::CompileOutcome.MayNotTerminate {{:rule __rule :fact-type __ft}} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")]) {g} {w})");
...
fn node_share_phase_census(n: i64, m: i64) -> Vec<(&'static str, u64, u64)> {
    let world = startup_from_source(NODE_SHARE_WORLD, None, Arc::new(InMemoryLoader::new()))
        .expect("node-share world should freeze");
    let staged = format!("(:nsh::seed (:wat::core::match (:wat::rete::compile (:nsh::build-rules {n})) [:wat::rete::CompileOutcome.Compiled {{:session __session}} __session] [:wat::rete::CompileOutcome.MayNotTerminate {{:rule __rule :fact-type __ft}} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")]) {m})");
    let src = format!("(:wat::core::match (:wat::rete::fire-rules {staged}) [:wat::rete::FireOutcome.Fired {{:value __fired}} __fired] [:wat::rete::FireOutcome.MemoryCeilingExceeded {{:limit __limit :used __used :rounds __rounds}} (:wat::kernel::assertion-failed! :message \"fire-rules: session memory ceiling exceeded\")] [:wat::rete::FireOutcome.RoundCapExceeded {{:cap __cap :still-deriving __still}} (:wat::kernel::assertion-failed! :message \"fire-rules: fixpoint round cap exceeded\")])");
    let ast = crate::parse_one!(src.as_str()).expect("parse the fire driver");
...
fn accum_count_census(g: i64, w: i64) -> Vec<(&'static str, u64)> {
    let world = startup_from_source(ACCUM_AXIS_WORLD, None, Arc::new(InMemoryLoader::new()))
        .expect("accum-axis world should freeze");
    let src = format!(
            "(:wat::core::match (:wat::rete::fire-rules (:apx::seed (:wat::core::match (:wat::rete::compile (:wat::rete::collect-rules :apx)) [:wat::rete::CompileOutcome.Compiled {{:session __session}} __session] [:wat::rete::CompileOutcome.MayNotTerminate {{:rule __rule :fact-type __ft}} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")]) {g} {w})) [:wat::rete::FireOutcome.Fired {{:value __fired}} __fired] [:wat::rete::FireOutcome.MemoryCeilingExceeded {{:limit __limit :used __used :rounds __rounds}} (:wat::kernel::assertion-failed! :message \"fire-rules: session memory ceiling exceeded\")] [:wat::rete::FireOutcome.RoundCapExceeded {{:cap __cap :still-deriving __still}} (:wat::kernel::assertion-failed! :message \"fire-rules: fixpoint round cap exceeded\")])"
        );
    let ast = crate::parse_one!(src.as_str()).expect("parse the fire driver");
    let (_fired, rows) = super::with_count_census(|| {
        eval_in_frozen(&ast, &world, &Environment::new())
...
fn one_rule_fold_ns(rule: &str, g: i64, w: i64) -> u64 {
    ...
    let src = format!(
            "(:wat::core::match (:wat::rete::fire-rules (:one::seed (:wat::core::match (:wat::rete::compile (:wat::rete::collect-rules :one)) [:wat::rete::CompileOutcome.Compiled {{:session __session}} __session] [:wat::rete::CompileOutcome.MayNotTerminate {{:rule __rule :fact-type __ft}} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")]) {g} {w})) [:wat::rete::FireOutcome.Fired {{:value __fired}} __fired] [:wat::rete::FireOutcome.MemoryCeilingExceeded {{:limit __limit :used __used :rounds __rounds}} (:wat::kernel::assertion-failed! :message \"fire-rules: session memory ceiling exceeded\")] [:wat::rete::FireOutcome.RoundCapExceeded {{:cap __cap :still-deriving __still}} (:wat::kernel::assertion-failed! :message \"fire-rules: fixpoint round cap exceeded\")])"
        );
    let ast = crate::parse_one!(src.as_str()).expect("parse the fire driver");
...
fn bind_world_alpha_ns(reading_cond: &str, n: i64) -> u64 {
    ...
    let src = format!(
            "(:wat::core::match (:wat::rete::fire-rules (:bnd::seed (:wat::core::match (:wat::rete::compile (:wat::rete::collect-rules :bnd)) [:wat::rete::CompileOutcome.Compiled {{:session __session}} __session] [:wat::rete::CompileOutcome.MayNotTerminate {{:rule __rule :fact-type __ft}} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")]) {n})) [:wat::rete::FireOutcome.Fired {{:value __fired}} __fired] [:wat::rete::FireOutcome.MemoryCeilingExceeded {{:limit __limit :used __used :rounds __rounds}} (:wat::kernel::assertion-failed! :message \"fire-rules: session memory ceiling exceeded\")] [:wat::rete::FireOutcome.RoundCapExceeded {{:cap __cap :still-deriving __still}} (:wat::kernel::assertion-failed! :message \"fire-rules: fixpoint round cap exceeded\")])"
        );
    let ast = crate::parse_one!(src.as_str()).expect("parse the fire driver");
    let (_fired, rows) = super::with_phase_census(|| {
        eval_in_frozen(&ast, &world, &Environment::new())
...
fn accum_alpha_memory_shape() {
    let world = startup_from_source(ACCUM_AXIS_WORLD, None, Arc::new(InMemoryLoader::new()))
        .expect("accum-axis world should freeze");
    let src = "(:wat::core::match (:wat::rete::fire-rules (:apx::seed (:wat::core::match (:wat::rete::compile (:wat::rete::collect-rules :apx)) [:wat::rete::CompileOutcome.Compiled {:session __session} __session] [:wat::rete::CompileOutcome.MayNotTerminate {:rule __rule :fact-type __ft} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")]) 200 200)) [:wat::rete::FireOutcome.Fired {:value __fired} __fired] [:wat::rete::FireOutcome.MemoryCeilingExceeded {:limit __limit :used __used :rounds __rounds} (:wat::kernel::assertion-failed! :message \"fire-rules: session memory ceiling exceeded\")] [:wat::rete::FireOutcome.RoundCapExceeded {:cap __cap :still-deriving __still} (:wat::kernel::assertion-failed! :message \"fire-rules: fixpoint round cap exceeded\")])";
...
";
    ...
    let ast = crate::parse_one!("(:wat::core::match (:wat::rete::fire-rules (:bcd::seed 400)) [:wat::rete::FireOutcome.Fired {:value __fired} __fired] [:wat::rete::FireOutcome.MemoryCeilingExceeded {:limit __limit :used __used :rounds __rounds} (:wat::kernel::assertion-failed! :message \"fire-rules: session memory ceiling exceeded\")] [:wat::rete::FireOutcome.RoundCapExceeded {:cap __cap :still-deriving __still} (:wat::kernel::assertion-failed! :message \"fire-rules: fixpoint round cap exceeded\")])").expect("parse");
...
fn cascade_phase_census(depth: i64, width: i64) -> Vec<(&'static str, u64, u64)> {
    ...
    let src = format!(
            "(:wat::core::match (:wat::rete::fire-rules (:dc::seed-level-0 (:wat::core::match (:wat::rete::compile (:dc::build-rules {depth})) [:wat::rete::CompileOutcome.Compiled {{:session __session}} __session] [:wat::rete::CompileOutcome.MayNotTerminate {{:rule __rule :fact-type __ft}} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")]) {width})) [:wat::rete::FireOutcome.Fired {{:value __fired}} __fired] [:wat::rete::FireOutcome.MemoryCeilingExceeded {{:limit __limit :used __used :rounds __rounds}} (:wat::kernel::assertion-failed! :message \"fire-rules: session memory ceiling exceeded\")] [:wat::rete::FireOutcome.RoundCapExceeded {{:cap __cap :still-deriving __still}} (:wat::kernel::assertion-failed! :message \"fire-rules: fixpoint round cap exceeded\")])"
        );
    let ast = crate::parse_one!(src.as_str()).expect("parse the fire driver");
    let (_fired, rows) = super::with_phase_census_counted(|| {
        eval_in_frozen(&ast, &world, &Environment::new())
...
fn beta_write_read_traffic() {
    ...
    let (fanout, _fanout_rows) = traffic(
        ...
        "(:wat::core::match (:wat::rete::fire-rules (:fan::seed (:wat::core::match (:wat::rete::compile \
             (:wat::rete::collect-rules :fan)) [:wat::rete::CompileOutcome.Compiled {:session __session} __session] [:wat::rete::CompileOutcome.MayNotTerminate {:rule __rule :fact-type __ft} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")]) 100 20)) [:wat::rete::FireOutcome.Fired {:value __fired} __fired] [:wat::rete::FireOutcome.MemoryCeilingExceeded {:limit __limit :used __used :rounds __rounds} (:wat::kernel::assertion-failed! :message \"fire-rules: session memory ceiling exceeded\")] [:wat::rete::FireOutcome.RoundCapExceeded {:cap __cap :still-deriving __still} (:wat::kernel::assertion-failed! :message \"fire-rules: fixpoint round cap exceeded\")])",
    );
    let (cascade, cascade_rows) = traffic(
            "deep-cascade [10 x 100] — CHAINED joins (the CONTROL: middle betas must be read)",
            DEPTH_SPLIT_WORLD,
            "(:wat::core::match (:wat::rete::fire-rules (:dc::seed-level-0 (:wat::core::match (:wat::rete::compile (:dc::build-rules 10)) [:wat::rete::CompileOutcome.Compiled {:session __session} __session] [:wat::rete::CompileOutcome.MayNotTerminate {:rule __rule :fact-type __ft} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")]) 100)) [:wat::rete::FireOutcome.Fired {:value __fired} __fired] [:wat::rete::FireOutcome.MemoryCeilingExceeded {:limit __limit :used __used :rounds __rounds} (:wat::kernel::assertion-failed! :message \"fire-rules: session memory ceiling exceeded\")] [:wat::rete::FireOutcome.RoundCapExceeded {:cap __cap :still-deriving __still} (:wat::kernel::assertion-failed! :message \"fire-rules: fixpoint round cap exceeded\")])",
        );
    ...
    let (tri, tri_rows) = traffic(
        ...
        "(:wat::core::match (:wat::rete::fire-rules (:tri::seed (:wat::core::match (:wat::rete::compile \
             (:wat::rete::collect-rules :tri)) [:wat::rete::CompileOutcome.Compiled {:session __session} __session] [:wat::rete::CompileOutcome.MayNotTerminate {:rule __rule :fact-type __ft} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")]) 10 5)) [:wat::rete::FireOutcome.Fired {:value __fired} __fired] [:wat::rete::FireOutcome.MemoryCeilingExceeded {:limit __limit :used __used :rounds __rounds} (:wat::kernel::assertion-failed! :message \"fire-rules: session memory ceiling exceeded\")] [:wat::rete::FireOutcome.RoundCapExceeded {:cap __cap :still-deriving __still} (:wat::kernel::assertion-failed! :message \"fire-rules: fixpoint round cap exceeded\")])",
    );
...
fn cascade_kind_list_split() {
    let world = startup_from_source(DEPTH_SPLIT_WORLD, None, Arc::new(InMemoryLoader::new()))
        .expect("depth-split world should freeze");
    let src = "(:wat::core::match (:wat::rete::compile (:dc::build-rules 50)) [:wat::rete::CompileOutcome.Compiled {:session __session} __session] [:wat::rete::CompileOutcome.MayNotTerminate {:rule __rule :fact-type __ft} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")])";
...
fn intern_release_session_wat_mouth_drops_the_lease() {
    ...
    let world = startup_from_source(DEPTH_SPLIT_WORLD, None, Arc::new(InMemoryLoader::new()))
        .expect("depth-split world should freeze");
    let src = "(:wat::rete::release-session (:wat::core::match (:wat::rete::compile (:dc::build-rules 2)) [:wat::rete::CompileOutcome.Compiled {:session __session} __session] [:wat::rete::CompileOutcome.MayNotTerminate {:rule __rule :fact-type __ft} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")]))";
...
fn scoped_work_with_network_releases_the_lease_it_takes() {
    ...
    let inside_src = "(:wat::core::match (:wat::rete::compile-all (:sw::the-rules) (:sw::the-queries)) [:wat::rete::CompileOutcome.Compiled {:session __session} __session] [:wat::rete::CompileOutcome.MayNotTerminate {:rule __rule :fact-type __ft} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")])";
...
fn fanout_phase_census(keys: i64, fanout: i64) -> Vec<(&'static str, u64, u64)> {
    ...
    let staged = format!(
        "(:fan::seed (:wat::core::match (:wat::rete::compile (:wat::rete::collect-rules :fan)) [:wat::rete::CompileOutcome.Compiled {{:session __session}} __session] [:wat::rete::CompileOutcome.MayNotTerminate {{:rule __rule :fact-type __ft}} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")]) {keys} {fanout})"
    );
    let src = format!("(:wat::core::match (:wat::rete::fire-rules {staged}) [:wat::rete::FireOutcome.Fired {{:value __fired}} __fired] [:wat::rete::FireOutcome.MemoryCeilingExceeded {{:limit __limit :used __used :rounds __rounds}} (:wat::kernel::assertion-failed! :message \"fire-rules: session memory ceiling exceeded\")] [:wat::rete::FireOutcome.RoundCapExceeded {{:cap __cap :still-deriving __still}} (:wat::kernel::assertion-failed! :message \"fire-rules: fixpoint round cap exceeded\")])");
    let ast = crate::parse_one!(src.as_str()).expect("parse the fire driver");
    let (_fired, rows) = super::with_phase_census_counted(|| {
...
fn accum_query_harvest_split() {
    ...
    let shot = |with_query: bool| -> Shot {
        ...
        let compile = if with_query {
            ...
            "(:wat::core::match (:wat::rete::compile (:wat::rete::collect-rules :apx)) [:wat::rete::CompileOutcome.Compiled {:session __session} __session] [:wat::rete::CompileOutcome.MayNotTerminate {:rule __rule :fact-type __ft} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")])"
        };
...
fn strat_neg_query_harvest_split() {
    ...
    let shot = |with_query: bool| -> Shot {
        let compile = if with_query {
            format!("(:wat::core::match (:wat::rete::compile-all (:strat::build-rules {STRATA}) {QUERIES}) [:wat::rete::CompileOutcome.Compiled {{:session __session}} __session] [:wat::rete::CompileOutcome.MayNotTerminate {{:rule __rule :fact-type __ft}} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")])")
        } else {
            format!("(:wat::core::match (:wat::rete::compile (:strat::build-rules {STRATA})) [:wat::rete::CompileOutcome.Compiled {{:session __session}} __session] [:wat::rete::CompileOutcome.MayNotTerminate {{:rule __rule :fact-type __ft}} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")])")
        };
...
fn cascade_query_harvest_split() {
    ...
    let shot = |with_query: bool| -> Shot {
        let compile = if with_query {
            format!("(:wat::core::match (:wat::rete::compile-all (:dc::build-rules {DEPTH}) {QUERIES}) [:wat::rete::CompileOutcome.Compiled {{:session __session}} __session] [:wat::rete::CompileOutcome.MayNotTerminate {{:rule __rule :fact-type __ft}} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")])")
        } else {
            format!("(:wat::core::match (:wat::rete::compile (:dc::build-rules {DEPTH})) [:wat::rete::CompileOutcome.Compiled {{:session __session}} __session] [:wat::rete::CompileOutcome.MayNotTerminate {{:rule __rule :fact-type __ft}} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")])")
        };
        ...
        (:wat::core::match (:wat::rete::insert\n\
          (:wat::core::match (:wat::rete::insert\n\
            (:wat::core::match (:wat::rete::compile-all (:wat::rete::collect-rules :hs)\n\
              (:wat::core::PersistentVector (:hs::q-T) (:hs::q-U))) [:wat::rete::CompileOutcome.Compiled {:session __session} __session] [:wat::rete::CompileOutcome.MayNotTerminate {:rule __rule :fact-type __ft} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")])\n\
            (:hs::T 1)) [:wat::rete::InsertOutcome.Inserted {:session __staged} __staged] [:wat::rete::InsertOutcome.MemoryCeilingExceeded {:limit __ilimit :used __iused :staged __icount} (:wat::kernel::assertion-failed! :message \"insert: session memory ceiling exceeded while staging\")])\n\
          (:hs::T 2)) [:wat::rete::InsertOutcome.Inserted {:session __staged} __staged] [:wat::rete::InsertOutcome.MemoryCeilingExceeded {:limit __ilimit :used __iused :staged __icount} (:wat::kernel::assertion-failed! :message \"insert: session memory ceiling exceeded while staging\")])) [:wat::rete::FireOutcome.Fired {:value __fired} __fired] [:wat::rete::FireOutcome.MemoryCeilingExceeded {:limit __limit :used __used :rounds __rounds} (:wat::kernel::assertion-failed! :message \"fire-rules: session memory ceiling exceeded\")] [:wat::rete::FireOutcome.RoundCapExceeded {:cap __cap :still-deriving __still} (:wat::kernel::assertion-failed! :message \"fire-rules: fixpoint round cap exceeded\")])";
...
fn accum_alpha_leftover_split() {
    ...
    let world = startup_from_source(ACCUM_AXIS_WORLD, None, Arc::new(InMemoryLoader::new()))
        .expect("accum-axis world should freeze");
    let staged = "(:apx::seed (:wat::core::match (:wat::rete::compile (:wat::rete::collect-rules :apx)) [:wat::rete::CompileOutcome.Compiled {:session __session} __session] [:wat::rete::CompileOutcome.MayNotTerminate {:rule __rule :fact-type __ft} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")]) 200 200)";
        ...
        eval_in(
            ...
            "(:wat::core::let \
               [s0 (:wat::core::match (:wat::rete::compile-all (:wat::rete::collect-rules :n3) \
                ...
                s3 (:wat::core::match (:wat::rete::insert s2 (:n3::A :k 3)) [:wat::rete::InsertOutcome.Inserted {:session __staged} __staged] [:wat::rete::InsertOutcome.MemoryCeilingExceeded {:limit __ilimit :used __iused :staged __icount} (:wat::kernel::assertion-failed! :message \"insert: session memory ceiling exceeded while staging\")])]\
              (:wat::core::match (:wat::rete::fire-rules s3) [:wat::rete::FireOutcome.Fired {:value __fired} __fired] [:wat::rete::FireOutcome.MemoryCeilingExceeded {:limit __limit :used __used :rounds __rounds} (:wat::kernel::assertion-failed! :message \"fire-rules: session memory ceiling exceeded\")] [:wat::rete::FireOutcome.RoundCapExceeded {:cap __cap :still-deriving __still} (:wat::kernel::assertion-failed! :message \"fire-rules: fixpoint round cap exceeded\")]))",
        )
    });
...
fn strat_neg_stratum_split() {
    ...
    let seed_src = format!(
        "(:strat::seed-items (:wat::core::match (:wat::rete::compile (:strat::build-rules {STRATA})) [:wat::rete::CompileOutcome.Compiled {{:session __session}} __session] [:wat::rete::CompileOutcome.MayNotTerminate {{:rule __rule :fact-type __ft}} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")]) {ITEMS})"
    );
...
fn dbeta_gather_volume() {
    ...
    let strat = run(
        "strat-neg",
        STRAT_WORLD,
        format!("(:strat::seed-items (:wat::core::match (:wat::rete::compile (:strat::build-rules {STRATA})) [:wat::rete::CompileOutcome.Compiled {{:session __session}} __session] [:wat::rete::CompileOutcome.MayNotTerminate {{:rule __rule :fact-type __ft}} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")]) {ITEMS})"),
    );
    let accum = run(
        "accum",
        ACCUM_AXIS_WORLD,
        "(:apx::seed (:wat::core::match (:wat::rete::compile (:wat::rete::collect-rules :apx)) [:wat::rete::CompileOutcome.Compiled {:session __session} __session] [:wat::rete::CompileOutcome.MayNotTerminate {:rule __rule :fact-type __ft} (:wat::kernel::assertion-failed! :message \"compile: the rule set may not terminate\")]) 200 200)".to_string(),
    );
