...
/// @example (:wat::core::match (:wat::holon::Bundle (:wat::core::Vector :- [:wat::holon::HolonAST] (:wat::holon::leaf "role") (:wat::holon::leaf "filler"))) [:wat::core::Result::Ok {:value h} (:wat::holon::Bundle/first h)] (_ (:wat::holon::Bundle/first (:wat::holon::leaf "unreachable")))) #=> (:wat::core::match (:wat::holon::Bundle (:wat::core::Vector :- [:wat::holon::HolonAST] (:wat::holon::leaf "role") (:wat::holon::leaf "filler"))) [:wat::core::Result::Ok {:value h} (:wat::holon::Bundle/first h)] (_ (:wat::holon::Bundle/first (:wat::holon::leaf "unreachable"))))
