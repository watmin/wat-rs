...
/// @example (:wat::edn::ForeignRecord/class (:wat::core::match (:wat::edn::read-foreign "#some.unknown/Rec {:kind #some.unknown/Kind.Click {:n 42}}") [:wat::edn::ReadForeignOutcome::Value {:value fr} fr] [:wat::edn::ReadForeignOutcome::Malformed {:cause _} (:wat::kernel::assertion-failed! "bad fixture" :wat::core::None :wat::core::None)])) #=> "some::unknown::Rec"
/// @see     :wat::edn::ForeignRecord/get
...
/// @example (:wat::edn::ForeignVariant/variant (:wat::core::match (:wat::edn::read-foreign "#some.unknown/Kind.Click {:n 42}") [:wat::edn::ReadForeignOutcome::Value {:value fv} fv] [:wat::edn::ReadForeignOutcome::Malformed {:cause _} (:wat::kernel::assertion-failed! "bad fixture" :wat::core::None :wat::core::None)])) #=> :Click
...
/// @example (:wat::edn::ForeignVariant/enum-class (:wat::core::match (:wat::edn::read-foreign "#some.unknown/Kind.Click {:n 42}") [:wat::edn::ReadForeignOutcome::Value {:value fv} fv] [:wat::edn::ReadForeignOutcome::Malformed {:cause _} (:wat::kernel::assertion-failed! "bad fixture" :wat::core::None :wat::core::None)])) #=> "some::unknown::Kind"
...
/// @example (:wat::edn::ForeignVariant/fields (:wat::core::match (:wat::edn::read-foreign "#some.unknown/Kind.Click {:n 42}") [:wat::edn::ReadForeignOutcome::Value {:value fv} fv] [:wat::edn::ReadForeignOutcome::Malformed {:cause _} (:wat::kernel::assertion-failed! "bad fixture" :wat::core::None :wat::core::None)])) #=> (:wat::core::Vector :- [:wat::core::Value] 42)
/// @see     :wat::edn::ForeignVariant/variant
