...
/// @example (:wat::core::i64::> (:wat::core::string::length (:wat::io::TempFile/path (:wat::io::TempFile/new))) 0) #=> true
...
/// @example (:wat::core::i64::> (:wat::core::string::length (:wat::io::TempDir/path (:wat::io::TempDir/new))) 0) #=> true
