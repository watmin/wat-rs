...
const STDLIB_FILES: &[WatSource] = &[
    ...
    // 27 laws all mutation-proven, three live rete defects found by its first consumer.
    // Cost is PER SHAPE and no single number is honest: ~2.4us/point for `ints`,
    // ~33us/point for `coords`, ~287us/point for the `such-that o bind o record` shape
