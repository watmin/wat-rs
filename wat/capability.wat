...
(wat.core/defsurface wat.capability/Capability :nature wat.core/Struct
  :features
  [(grant      [self :- wat.capability/Capability  pids :- (wat.core/Vector :- [wat.core/i64])] :- wat.type/nil)
   (revoke     [self :- wat.capability/Capability  pids :- (wat.core/Vector :- [wat.core/i64])] :- wat.type/nil)
...
(wat.core/defsurface wat.capability/TypedCapability :- [S R] :nature wat.core/Struct
  ...
  [(coord  [self :- (wat.capability/TypedCapability :- [S R])] :- (wat.kernel/Address :- [S R]))
   (grant  [self :- (wat.capability/TypedCapability :- [S R])  pids :- (wat.core/Vector :- [wat.core/i64])] :- wat.type/nil)
   (revoke [self :- (wat.capability/TypedCapability :- [S R])  pids :- (wat.core/Vector :- [wat.core/i64])] :- wat.type/nil)])
