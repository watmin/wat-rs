...
(:wat::core::defn :wat::gen::ints [lo <- :wat::core::i64  hi <- :wat::core::i64]
  ...
  (:wat::gen::Gen :card (:wat::i64::- hi lo)
                    ...
                    [:wat::core::Option.None {}
                      (:wat::core::if (:wat::core::< (:wat::gen::Pick/rest acc) (:wat::gen::Gen/card g))
                        (:wat::gen::Pick :rest (:wat::gen::Pick/rest acc)
                                     :got (:wat::core::Option.Some {:value ((:wat::gen::Gen/at g) (:wat::gen::Pick/rest acc))}))
...
(:wat::core::defn :wat::gen::lift2 :- [A B R]
  ...
  (:wat::core::let [ca (:wat::gen::Gen/card ga)
    ...
    (:wat::gen::Gen :card (:wat::i64::* ca (:wat::gen::Gen/card gb))
...
(:wat::core::defn :wat::gen::lift3 :- [A B C R]
  ...
  (:wat::core::let [ca (:wat::gen::Gen/card ga)
    ...
    (:wat::gen::Gen :card (:wat::i64::* (:wat::i64::* ca cb) (:wat::gen::Gen/card gc))
                :at (:wat::core::fn [i <- :wat::core::i64] -> R
                        ...
                        (:wat::core::let [c (:wat::gen::nth cards i)
                          ...
                          (:wat::core::if (:wat::core::< r c)
                            (:wat::gen::BindPick :rest r
                              :got (:wat::core::Option.Some {:value ((:wat::gen::Gen/at (f (ga-at i))) r)}))
                            (:wat::gen::BindPick :rest (:wat::i64::- r c)
                              :got :wat::core::Option.None)))]))
                  (:wat::gen::BindPick :rest k :got :wat::core::Option.None)
                  (:wat::core::range 0 n)))
