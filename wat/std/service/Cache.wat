;; :wat::std::service::Cache<K,V> — the L2 tier of 058 FOUNDATION's
...
;; they can live under `:wat::std::service::Cache::*`. Every signature
;; in the file uses the alias names; `reduce` (src/check.rs) walks
;; through at unification + shape-inspection sites, so
;; `:wat::std::service::Cache::Request<i64,String>` and its tuple
...
(:wat::core::typealias :wat::std::service::Cache::Body<K,V>
  :(i64,K,Option<V>))
(:wat::core::typealias :wat::std::service::Cache::ReplyTx<V>
  :rust::crossbeam_channel::Sender<Option<V>>)
(:wat::core::typealias :wat::std::service::Cache::Request<K,V>
  :(wat::std::service::Cache::Body<K,V>,wat::std::service::Cache::ReplyTx<V>))
(:wat::core::typealias :wat::std::service::Cache::ReqTx<K,V>
  :rust::crossbeam_channel::Sender<wat::std::service::Cache::Request<K,V>>)
(:wat::core::typealias :wat::std::service::Cache::ReqRx<K,V>
  :rust::crossbeam_channel::Receiver<wat::std::service::Cache::Request<K,V>>)
...
(:wat::core::define
  (:wat::std::service::Cache/loop<K,V>
    (capacity :i64)
    (req-rxs :Vec<wat::std::service::Cache::ReqRx<K,V>>)
    -> :())
  (:wat::core::let*
    (((cache :wat::std::LocalCache<K,V>)
      (:wat::std::LocalCache::new capacity)))
    (:wat::std::service::Cache/loop-step cache req-rxs)))
...
(:wat::core::define
  (:wat::std::service::Cache/loop-step<K,V>
    (cache :wat::std::LocalCache<K,V>)
    (req-rxs :Vec<wat::std::service::Cache::ReqRx<K,V>>)
    -> :())
  (:wat::core::if (:wat::core::empty? req-rxs) -> :()
    ()
    (:wat::core::let*
      (((chosen :(i64,Option<wat::std::service::Cache::Request<K,V>>))
        (:wat::kernel::select req-rxs))
       ((idx :i64) (:wat::core::first chosen))
       ((maybe :Option<wat::std::service::Cache::Request<K,V>>)
        (:wat::core::second chosen)))
      (:wat::core::match maybe -> :()
        ((Some req)
          (:wat::core::let*
            (((body :wat::std::service::Cache::Body<K,V>) (:wat::core::first req))
             ((reply-to :wat::std::service::Cache::ReplyTx<V>)
              (:wat::core::second req))
            ...
            (:wat::std::service::Cache/loop-step cache req-rxs)))
        (:None
          (:wat::std::service::Cache/loop-step
            cache
...
(:wat::core::define
  (:wat::std::service::Cache/get<K,V>
    (req-tx :wat::std::service::Cache::ReqTx<K,V>)
    (reply-tx :wat::std::service::Cache::ReplyTx<V>)
    (reply-rx :rust::crossbeam_channel::Receiver<Option<V>>)
    (key :K)
    -> :Option<V>)
  (:wat::core::let*
    (((body :wat::std::service::Cache::Body<K,V>)
      (:wat::core::tuple 0 key :None))
     ((req :wat::std::service::Cache::Request<K,V>)
...
(:wat::core::define
  (:wat::std::service::Cache<K,V>
    (capacity :i64)
    (count :i64)
    -> :(wat::kernel::HandlePool<wat::std::service::Cache::ReqTx<K,V>>,wat::kernel::ProgramHandle<()>))
  (:wat::core::let*
    (((pairs :Vec<(wat::std::service::Cache::ReqTx<K,V>,wat::std::service::Cache::ReqRx<K,V>)>)
      (:wat::core::map
        (:wat::core::range 0 count)
        (:wat::core::lambda ((_i :i64) -> :(wat::std::service::Cache::ReqTx<K,V>,wat::std::service::Cache::ReqRx<K,V>))
          (:wat::kernel::make-bounded-queue :wat::std::service::Cache::Request<K,V> 1))))
     ((req-txs :Vec<wat::std::service::Cache::ReqTx<K,V>>)
      (:wat::core::map pairs
        (:wat::core::lambda ((p :(wat::std::service::Cache::ReqTx<K,V>,wat::std::service::Cache::ReqRx<K,V>))
                            -> :wat::std::service::Cache::ReqTx<K,V>)
          (:wat::core::first p))))
     ((req-rxs :Vec<wat::std::service::Cache::ReqRx<K,V>>)
      (:wat::core::map pairs
        (:wat::core::lambda ((p :(wat::std::service::Cache::ReqTx<K,V>,wat::std::service::Cache::ReqRx<K,V>))
                            -> :wat::std::service::Cache::ReqRx<K,V>)
          (:wat::core::second p))))
     ((pool :wat::kernel::HandlePool<wat::std::service::Cache::ReqTx<K,V>>)
      (:wat::kernel::HandlePool::new "Cache" req-txs))
     ((driver :wat::kernel::ProgramHandle<()>)
      (:wat::kernel::spawn :wat::std::service::Cache/loop capacity req-rxs)))
