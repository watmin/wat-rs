          ...
          (:wat::core::let [a (:wat::core::Option/expect (:wat::core::get act-slot 0) "actual")]
            (:wat::core::if has-exp
              (:wat::core::let [e (:wat::core::Option/expect (:wat::core::get exp-slot 0) "expected")]
                (:wat::core::if (str? a)
                  (:wat::core::if (str? e)
                    `(:wat::kernel::assertion-failed!' ~msg (:wat::core::Some ~a) (:wat::core::Some ~e))
                    `(:wat::kernel::assertion-failed!' ~msg (:wat::core::Some ~a) ~e))
                  (:wat::core::if (str? e)
                    `(:wat::kernel::assertion-failed!' ~msg ~a (:wat::core::Some ~e))
                    `(:wat::kernel::assertion-failed!' ~msg ~a ~e))))
              (:wat::core::if (str? a)
                `(:wat::kernel::assertion-failed!' ~msg (:wat::core::Some ~a) :wat::core::None)
                `(:wat::kernel::assertion-failed!' ~msg ~a :wat::core::None))))
          (:wat::core::if has-exp
            (:wat::core::let [e (:wat::core::Option/expect (:wat::core::get exp-slot 0) "expected")]
              (:wat::core::if (str? e)
                `(:wat::kernel::assertion-failed!' ~msg :wat::core::None (:wat::core::Some ~e))
                `(:wat::kernel::assertion-failed!' ~msg :wat::core::None ~e)))
