...
(:wat::core::define
  (:wat::kernel::services::StdOutService/routing-rxs
    (routing-vec :wat::kernel::services::StdOutService::RoutingVec)
    -> :wat::core::Vector<wat::kernel::services::StdOutService::EventRx>)
...
(:wat::core::define
  (:wat::kernel::services::StdOutService/handle-add
    (routing-vec :wat::kernel::services::StdOutService::RoutingVec)
    (thread-id :wat::kernel::ThreadId)
    (data-rx :wat::kernel::services::StdOutService::EventRx)
    (ack-tx :wat::kernel::Sender<wat::core::nil>)
    -> :wat::kernel::services::StdOutService::RoutingVec)
...
(:wat::core::define
  (:wat::kernel::services::StdOutService/handle-write
    (routing-vec :wat::kernel::services::StdOutService::RoutingVec)
...
(:wat::core::define
  (:wat::kernel::services::StdOutService/dispatch
    (routing-vec :wat::kernel::services::StdOutService::RoutingVec)
    (writer :wat::io::IOWriter)
    (control-rx :wat::kernel::services::StdOutService::EventRx)
    (idx :wat::core::i64)
    (maybe :wat::kernel::CommResult<wat::kernel::services::StdOutService::Event>)
    -> :wat::core::nil)
  (:wat::core::let
    [routing-len
