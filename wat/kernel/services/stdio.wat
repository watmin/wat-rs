...
(:wat::service::defservice :wat::kernel::stdout-svc
  ...
  [(write [s ctx req]
     (:wat::core::let [_bytes (:wat::io::IOWriter/write-string (:wat::kernel::stdout-svc::State/out s)
       ...
       (:wat::service::Outcome::Continue s (:wat::core::Some (:wat::kernel::StdOut::Reply::Write (:wat::kernel::StdOut::WriteResponse::Ok))) (:wat::core::Vector :- [(:wat::service::Directed :- [:wat::kernel::StdOut::Reply])]) (:wat::core::Vector :- [(:wat::service::Alarm :- [:wat::kernel::stdout-svc::Op])]))))])
...
(:wat::service::defservice :wat::kernel::stderr-svc
  ...
  [(write [s ctx req]
     (:wat::core::let [_bytes (:wat::io::IOWriter/write-string (:wat::kernel::stderr-svc::State/out s)
       ...
       (:wat::service::Outcome::Continue s (:wat::core::Some (:wat::kernel::StdErr::Reply::Write (:wat::kernel::StdErr::WriteResponse::Ok))) (:wat::core::Vector :- [(:wat::service::Directed :- [:wat::kernel::StdErr::Reply])]) (:wat::core::Vector :- [(:wat::service::Alarm :- [:wat::kernel::stderr-svc::Op])]))))])
...
(:wat::service::defservice :wat::kernel::stdin-svc
  ...
  [(read-frame [s ctx req]
     (:wat::service::Outcome::Continue s
       (:wat::core::Some (:wat::kernel::StdIn::Reply::ReadFrame (:wat::core::match (:wat::io::IOReader/read-frame (:wat::kernel::stdin-svc::State/in s)
         ...
         (:wat::io::IOReader::ReadFrameOutcome::Stopped      (:wat::kernel::StdIn::ReadFrameResponse::Stopped))))) (:wat::core::Vector :- [(:wat::service::Directed :- [:wat::kernel::StdIn::Reply])]) (:wat::core::Vector :- [(:wat::service::Alarm :- [:wat::kernel::stdin-svc::Op])])))])
        ...
        [take  (:wat::core::if (:wat::i64::< len :wat::kernel::STDIO-WRITE-CHUNK-CHARS) len :wat::kernel::STDIO-WRITE-CHUNK-CHARS)
         ...
         _ack  (:wat::core::match (:wat::kernel::StdOut/write peer (:wat::kernel::StdOut::WriteRequest :bytes chunk))
                 ...
                 (:wat::kernel::RecvOutcome::Closed
                   (:wat::kernel::assertion-failed! "println: stdout service peer closed" :wat::core::None :wat::core::None)) (:wat::kernel::RecvOutcome::TimedOut (:wat::kernel::assertion-failed! "recv: timed out — the peer is alive and silent" :wat::core::None :wat::core::None)) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None)))]
      ...
      (:wat::core::let
        [take  (:wat::core::if (:wat::i64::< len :wat::kernel::STDIO-WRITE-CHUNK-CHARS) len :wat::kernel::STDIO-WRITE-CHUNK-CHARS)
         ...
         _ack  (:wat::core::match (:wat::kernel::StdErr/write peer (:wat::kernel::StdErr::WriteRequest :bytes chunk))
                 ...
                 (:wat::kernel::RecvOutcome::Closed
                   (:wat::kernel::assertion-failed! "eprintln: stderr service peer closed" :wat::core::None :wat::core::None)) (:wat::kernel::RecvOutcome::TimedOut (:wat::kernel::assertion-failed! "recv: timed out — the peer is alive and silent" :wat::core::None :wat::core::None)) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None)))]
...
(:wat::core::defn :wat::kernel::stdio-read
  ...
  (:wat::core::match (:wat::kernel::StdIn/read-frame peer (:wat::kernel::StdIn::ReadFrameRequest :max-buffer-bytes cap))
    ...
    (:wat::kernel::RecvOutcome::Closed
      (:wat::kernel::assertion-failed! "readln: stdin service peer closed" :wat::core::None :wat::core::None)) (:wat::kernel::RecvOutcome::TimedOut (:wat::kernel::assertion-failed! "recv: timed out — the peer is alive and silent" :wat::core::None :wat::core::None)) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None))))
...
(:wat::core::defn :wat::kernel::stdio-read-frame
  ...
  (:wat::core::match (:wat::kernel::StdIn/read-frame peer (:wat::kernel::StdIn::ReadFrameRequest :max-buffer-bytes cap))
    ...
    ((:wat::kernel::RecvOutcome::Lost cause)
      (:wat::kernel::assertion-failed! (:wat::kernel::LociDiedError/message cause) :wat::core::None :wat::core::None))
    (:wat::kernel::RecvOutcome::Closed
      (:wat::kernel::assertion-failed! "read-frame: stdin service peer closed" :wat::core::None :wat::core::None)) (:wat::kernel::RecvOutcome::TimedOut (:wat::kernel::assertion-failed! "recv: timed out — the peer is alive and silent" :wat::core::None :wat::core::None)) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None))))
