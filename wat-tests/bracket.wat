...
;; ── map over a queue-opts locus: doubles, in input order ──────────────────────
(:wat::test::deftest :wat-tests::bracket::map-on-queue-doubles-in-order
  ...
  (:wat::core::let
    ...
    (:wat::test::assert-eq
      (:wat::bracket::map
        (:wat::bracket::queue-opts q addr "wtq" 2 1000000000 8000)
        (:wat::core::Vector :- [:wat::core::i64] 1 2 3 4 5)
        (:wat::core::fn [x <- :wat::core::i64] -> :wat::core::i64 (:wat::core::* x 2)))
      (:wat::core::Vector :- [:wat::core::i64] 2 4 6 8 10))))
