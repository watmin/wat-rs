;; wat-tests/kernel/services/stdout.wat — hermetic deftests for StdOutService.
;;
;; Arc 170 slice 1f-β-ii.  Each test runs in a forked OS process via
...
;; 1f-β-iii / 1f-γ / 1f-δ ship and `deftest-hermetic` migrates to
;; `spawn-process`.  Until then each test is counted as a known failure
;; at the § Row K boundary — same status as stdin.wat tests.
;;
...
;;   Layer 0 :stdout-test::spawn-shape          (A)
;;   Layer 1 :stdout-test::add-and-write        (B)
;;   Layer 2 :stdout-test::remove-drops-entry   (C)
;;   Layer 3 :stdout-test::multi-thread-routing (D)
;;   Layer 4 :stdout-test::scope-drop-shutdown  (E)
...
(:wat::test::deftest-hermetic
  :stdout-test::spawn-shape
  ()
  (:wat::core::let
    [writer
      (:wat::io::IOWriter/new)
     spawn
      (:wat::kernel::services::StdOutService/spawn writer)
     thr
     ...
     _add
      (:wat::core::Result/expect -> :wat::core::nil
        (:wat::kernel::send ctrl-tx
          (:wat::kernel::services::StdOutService::Event::Add 1 data-rx ack-tx))
        "add-and-write: ctrl-tx disconnected on Add")
     ;; Send Write request on data-tx.
     _write
      (:wat::core::Result/expect -> :wat::core::nil
        (:wat::kernel::send data-tx
          (:wat::kernel::services::StdOutService::Event::Write "hello stdout"))
...
(:wat::test::deftest-hermetic
  :stdout-test::remove-drops-entry
  ()
  (:wat::core::let
    [writer
      (:wat::io::IOWriter/new)
     ...
     _add
      (:wat::core::Result/expect -> :wat::core::nil
        (:wat::kernel::send ctrl-tx
          (:wat::kernel::services::StdOutService::Event::Add 2 data-rx ack-tx))
        "remove-drops-entry: ctrl-tx disconnected on Add")
     ;; Remove thread 2.
     _remove
      (:wat::core::Result/expect -> :wat::core::nil
        (:wat::kernel::send ctrl-tx
          (:wat::kernel::services::StdOutService::Event::Remove 2))
...
(:wat::test::deftest-hermetic
  :stdout-test::multi-thread-routing
  ()
  (:wat::core::let
    [writer
      (:wat::io::IOWriter/new)
     ...
     _add1
      (:wat::core::Result/expect -> :wat::core::nil
        (:wat::kernel::send ctrl-tx
          (:wat::kernel::services::StdOutService::Event::Add 1 data-rx1 ack-tx1))
        "multi-thread: ctrl-tx Add 1 disconnected")
     _add2
      (:wat::core::Result/expect -> :wat::core::nil
        (:wat::kernel::send ctrl-tx
          (:wat::kernel::services::StdOutService::Event::Add 2 data-rx2 ack-tx2))
        "multi-thread: ctrl-tx Add 2 disconnected")
     ;; Thread 1 writes first.
     _write1
      (:wat::core::Result/expect -> :wat::core::nil
        (:wat::kernel::send data-tx1
          (:wat::kernel::services::StdOutService::Event::Write "line-one"))
     ...
     _write2
      (:wat::core::Result/expect -> :wat::core::nil
        (:wat::kernel::send data-tx2
          (:wat::kernel::services::StdOutService::Event::Write "line-two"))
...
(:wat::test::deftest-hermetic
  :stdout-test::scope-drop-shutdown
  ()
  (:wat::core::let
    [writer
      (:wat::io::IOWriter/new)
