...
(:wat::test::deftest :wat-tests::holon::Filter::test-filter-coincident-rejects-far
  ()
  (:wat::core::let
    (((f :wat::core::Fn(wat::core::f64)->wat::core::bool) (:wat::holon::filter-coincident)))
...
(:wat::test::deftest :wat-tests::holon::Filter::test-filter-present-rejects-zero
  ()
  (:wat::core::let
    (((f :wat::core::Fn(wat::core::f64)->wat::core::bool) (:wat::holon::filter-present)))
...
(:wat::test::deftest :wat-tests::holon::Filter::test-filter-accept-any-on-zero
  ()
  (:wat::core::let
    (((f :wat::core::Fn(wat::core::f64)->wat::core::bool) (:wat::holon::filter-accept-any)))
