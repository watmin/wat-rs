...
(:wat::test::deftest :wat-tests::holon::Filter::test-filter-coincident-rejects-far
  ()
  (:wat::core::let*
    (((f :fn(f64)->bool) (:wat::holon::filter-coincident 10000)))
...
(:wat::test::deftest :wat-tests::holon::Filter::test-filter-present-rejects-zero
  ()
  (:wat::core::let*
    (((f :fn(f64)->bool) (:wat::holon::filter-present 10000)))
...
;; ─── End-to-end: filter-coincident composes with Hologram/get ────
;;
;; Build a Hologram, put a (k, v) pair, then look up with the
;; substrate-default filter. Self-cosine is 1.0 → filter accepts → Some.
  ...
  (:wat::core::let*
    (((store :wat::holon::Hologram) (:wat::holon::Hologram/new 10000))
     ...
     ((got :Option<wat::holon::HolonAST>)
      (:wat::holon::Hologram/get store 5.0 k
