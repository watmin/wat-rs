...
;;
;; TARGET: `:wat::string::split` and `::join`, real substrate verbs.
...
(:wat::core::defn :wat-tests::pat::run-real
  ...
  (:wat::core::foldl
    (:wat::core::fn [m <- (:wat::core::PersistentMap :- [:wat::core::i64 :wat::core::i64])
                    ...
                    -> (:wat::core::PersistentMap :- [:wat::core::i64 :wat::core::i64])
      (:wat::core::match c
        ((:wat-tests::pat::Cmd::Put k v) (:wat::map::assoc m k v))
        ((:wat-tests::pat::Cmd::Del k)   (:wat::map::dissoc m k))))
...
(:wat::core::defn :wat-tests::pat::law-dependent
  ...
  (:wat::core::let
    ...
    (:wat::core::match (:wat::vector::get v idx)
      ((:wat::core::Some got) (:wat::core::= got (:wat::i64::* idx 10)))
      (:wat::core::None       false))))
