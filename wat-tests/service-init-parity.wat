  ...
  (:wat::test::assert-eq
    (:wat::core::let
      ...
      (:wat::core::match r [:wat::kernel::RecvOutcome::Message {:msg __recv} (:wat::core::match __recv  
        [:wat-tests::SeededCounter::GetResponse::Ok {:value value} value]
        ;; terminal caller: an unexpected wire-breach must SURFACE, never swallow.
        [:wat-tests::SeededCounter::GetResponse::RequestTooLarge {:bytes bytes :cap cap}
          (:wat::kernel::assertion-failed! :message "seeded-counter-get: unexpected RequestTooLarge")]
        [:wat-tests::SeededCounter::GetResponse::RequestMalformed {:path mpath :expected mexpected :got mgot}
