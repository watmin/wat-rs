...
(:wat::config::set-redef! true)
   ...
   ;; Its make-channel is a thread-tier channel; 293.W.2d made make-channel tier-aware (a thread
   ;; channel accepts :Impure; a wire channel requires :Pure), so this test now RUNS (the ledgered
   ;; ignore was removed when 2d landed — the IGNORE LEDGER is empty).
   ...
   (:wat::core::typealias :svc::Spawn
     :(svc::ReqTxPool,wat::kernel::Thread<wat::core::nil,svc::State>))
   ...
   (:wat::core::defn :test::svc-spawn-and-shutdown [] -> :wat::core::nil
     (:wat::core::let
            [driver
              (:wat::core::let
                [spawn (:svc::Service 1)
                 ...
                 _req-tx (:wat::kernel::HandlePool::pop pool)
   ...
   (:wat::core::defn :test::svc-send-push [req-tx <- :svc::ReqTx v <- :wat::core::i64] -> :wat::core::nil
     (:wat::core::Result/expect  
   ...
   (:wat::core::defn :test::svc-full-sequence-and-verify [] -> :wat::core::nil
     (:wat::core::let
            [thr
              (:wat::core::let
                [spawn (:svc::Service 1)
                 ...
                 _ (:test::svc-send-push req-tx 100)
                 _ (:test::svc-send-push req-tx 200)
                 _
                  (:wat::core::Result/expect  
                 ...
                 _ (:test::svc-assert-state snap1 2 1)
                 _ (:test::svc-send-push req-tx 300)
                 _
                  (:wat::core::Result/expect  
                    (:wat::kernel::send req-tx (:svc::Request::Get get-tx))
                 ...
                 _ (:test::svc-assert-state snap2 3 1)]
                d)
             final-rx
    ...
    [thr
      (:wat::core::let
        [spawn (:svc::Service 1)
         ...
         req-tx (:wat::kernel::HandlePool::pop pool)
         _finish (:wat::kernel::HandlePool::finish pool)
         _ (:test::svc-send-push req-tx 42)]
        d)
     final-rx
      (:wat::kernel::Thread/output thr)
     _final-state
