    ...
    [rs (:wat-tests::rete::rules::rule-set
     ...
     s0 (:wat::core::match (:wat::rete::compile-all rs
          (:wat::core::PersistentVector
            ...
            (:wat-tests::rete::rules::q-two-at))) ((:wat::rete::CompileOutcome::Compiled __session) __session) ((:wat::rete::CompileOutcome::MayNotTerminate __rule __fact-type) (:wat::kernel::assertion-failed! "compile: the rule set may not terminate" :wat::core::None :wat::core::None)))
