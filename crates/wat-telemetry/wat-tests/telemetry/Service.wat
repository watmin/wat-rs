    ...
    (((driver :wat::kernel::Thread<(),()>)
      (:wat::core::let*
        (((stub-pair :wat::kernel::QueuePair<wat::core::i64>)
         ...
         ((dispatcher :fn(Vec<wat::core::i64>)->())
          (:wat::core::lambda ((entries :Vec<wat::core::i64>) -> :())
            (:wat::core::foldl entries ()
              (:wat::core::lambda ((_acc :()) (e :wat::core::i64) -> :())
                (:wat::core::match (:wat::kernel::send stub-tx e) -> :()
                  ((Ok _) ())
                  ((Err _) ()))))))
         ((stats-translator :fn(wat::telemetry::Service::Stats)->Vec<wat::core::i64>)
          (:wat::core::lambda
            ((_s :wat::telemetry::Service::Stats) -> :Vec<wat::core::i64>)
...
(:wat::test::deftest :wat-telemetry::test-batch-roundtrip
  ...
  (:wat::core::let*
    ...
    ;; § "The lockstep" + arc 117.
    (((thr-and-rx :(wat::kernel::Thread<(),()>,wat::kernel::QueueReceiver<wat::core::i64>))
      (:wat::core::let*
        (((stub-pair :wat::kernel::QueuePair<wat::core::i64>)
          (:wat::kernel::make-bounded-queue :wat::core::i64 16))
         ((stub-tx :wat::kernel::QueueSender<wat::core::i64>) (:wat::core::first stub-pair))
         ...
         ((_inner :())
          (:wat::core::let*
            (((handle :wat::telemetry::Service::Handle<wat::core::i64>)
             ...
             ((entries :Vec<wat::core::i64>) (:wat::core::vec :wat::core::i64 10 20 30))
             ((_log :())
              (:wat::telemetry::Service/batch-log req-tx ack-rx entries)))
            ())))
        (:wat::core::tuple d stub-rx)))
     ((driver :wat::kernel::Thread<(),()>) (:wat::core::first thr-and-rx))
    ...
    (((thr-and-rx :(wat::kernel::Thread<(),()>,wat::kernel::QueueReceiver<wat::core::i64>))
      (:wat::core::let*
        (((stub-pair :wat::kernel::QueuePair<wat::core::i64>)
         ...
         ((cadence :wat::telemetry::Service::MetricsCadence<wat::core::i64>)
         ...
         ((_inner :())
          (:wat::core::let*
            (((handle :wat::telemetry::Service::Handle<wat::core::i64>)
             ...
             ((ack-rx :wat::telemetry::Service::AckRx)
              (:wat::core::second handle))
             ((entries :Vec<wat::core::i64>) (:wat::core::vec :wat::core::i64 100 200))
             ((_log :())
              (:wat::telemetry::Service/batch-log req-tx ack-rx entries)))
            ())))
        (:wat::core::tuple d stub-rx)))
