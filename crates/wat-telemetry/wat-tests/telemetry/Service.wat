...
(:wat::test::deftest :wat-telemetry::test-batch-roundtrip
  ...
  (:wat::core::let*
    (((stub-pair :wat::kernel::QueuePair<i64>)
     ...
     ((v1 :wat::core::i64)
      (:wat::core::match (:wat::kernel::recv stub-rx) -> :wat::core::i64 ((Some v) v) (:None -1)))
     ((v2 :wat::core::i64)
      (:wat::core::match (:wat::kernel::recv stub-rx) -> :wat::core::i64 ((Some v) v) (:None -1)))
     ((v3 :wat::core::i64)
      (:wat::core::match (:wat::kernel::recv stub-rx) -> :wat::core::i64 ((Some v) v) (:None -1)))
    ...
    (((stub-pair :wat::kernel::QueuePair<i64>)
     ...
     ((_inner :())
      (:wat::core::let*
        ...
        ()))
     ((_join :()) (:wat::kernel::join driver))
     ((v1 :wat::core::i64) (:wat::core::match (:wat::kernel::recv stub-rx) -> :wat::core::i64 ((Some v) v) (:None 0)))
     ((v2 :wat::core::i64) (:wat::core::match (:wat::kernel::recv stub-rx) -> :wat::core::i64 ((Some v) v) (:None 0)))
     ((v3 :wat::core::i64) (:wat::core::match (:wat::kernel::recv stub-rx) -> :wat::core::i64 ((Some v) v) (:None 0)))
