                ...
                (:wat::core::let*
                  (((con-pool :wat::kernel::HandlePool<wat::console::Handle>)
                   ...
                   ((reply-pair :wat::kernel::QueuePair<wat::core::Option<wat::core::i64>>)
                    (:wat::kernel::make-bounded-queue :wat::core::Option<wat::core::i64> 1))
                   ((reply-tx :wat::kernel::QueueSender<wat::core::Option<wat::core::i64>>)
                    (:wat::core::first reply-pair))
                   ((reply-rx :wat::kernel::QueueReceiver<wat::core::Option<wat::core::i64>>)
