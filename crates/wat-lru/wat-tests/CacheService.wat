          ...
          (:wat::core::define
            ...
            (:wat::core::let*
              (((con-state :(wat::kernel::HandlePool<rust::crossbeam_channel::Sender<(i64,String)>>,wat::kernel::ProgramHandle<()>))
               ...
               ((state :(wat::kernel::HandlePool<user::wat::std::lru::CacheService::ReqTx<String,i64>>,wat::kernel::ProgramHandle<()>))
                (:user::wat::std::lru::CacheService 16 1))
               ...
               ((_ :())
                (:wat::core::let*
                  (((con-pool :wat::kernel::HandlePool<rust::crossbeam_channel::Sender<(i64,String)>>)
                   ...
                   ((pool :wat::kernel::HandlePool<user::wat::std::lru::CacheService::ReqTx<String,i64>>)
                    (:wat::core::first state))
                   ((req-tx :user::wat::std::lru::CacheService::ReqTx<String,i64>)
                   ...
                   ((_ :()) (:user::wat::std::lru::CacheService/put req-tx reply-tx reply-rx "answer" 42))
                   ((_ :()) (:wat::std::service::Console/err diag "T2: put-acked\n"))
                   ((got :Option<i64>)
                    (:user::wat::std::lru::CacheService/get req-tx reply-tx reply-rx "answer"))
