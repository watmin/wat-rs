...
(:wat::core::defn :my::test::call-process-join [proc <- :wat::kernel::Process<wat::core::nil,wat::core::nil>] -> :wat::core::Result<wat::core::nil,wat::core::Vector<wat::kernel::LociDiedError>> (:wat::kernel::Process/join-result proc))
