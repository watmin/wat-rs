...
(:wat::core::defn :user::gate-4a-lt [] -> :wat::core::bool (:wat::core::i64::< 1 2))
(:wat::core::defn :user::gate-4a-gt [] -> :wat::core::bool (:wat::core::i64::> 5 3))

;; GATE 4b — f64 NaN ordering (0.0 / 0.0 produces NaN; 1.0 < NaN is false per IEEE 754)
(:wat::core::defn :user::gate-4b-nan [] -> :wat::core::bool
  (:wat::core::f64::< 1.0 (:wat::core::f64::/ 0.0 0.0)))
...
(:wat::core::defn :user::mint-i64-lte-boundary [] -> :wat::core::bool (:wat::core::i64::<= 5 5))
(:wat::core::defn :user::mint-i64-lte-false [] -> :wat::core::bool (:wat::core::i64::<= 5 3))
(:wat::core::defn :user::mint-f64-lt [] -> :wat::core::bool (:wat::core::f64::< 1.0 2.0))
(:wat::core::defn :user::mint-f64-gte [] -> :wat::core::bool (:wat::core::f64::>= 5.0 5.0))
