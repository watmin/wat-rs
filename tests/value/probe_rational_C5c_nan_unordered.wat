...
(:wat::core::defn :probe::row4-gt [] -> :wat::core::bool (:wat::core::> 1 (:wat::f64::/ 0.0 0.0))) ; -> false

;; row 2/3 — the defect: <= and >= with NaN on the right. Were the wart (true); now false.
(:wat::core::defn :probe::row2-le [] -> :wat::core::bool (:wat::core::<= 1 (:wat::f64::/ 0.0 0.0))) ; -> false
(:wat::core::defn :probe::row3-ge [] -> :wat::core::bool (:wat::core::>= 1 (:wat::f64::/ 0.0 0.0))) ; -> false

;; row 5 — NaN on the LEFT, all four ops.
(:wat::core::defn :probe::row5-lt [] -> :wat::core::bool (:wat::core::< (:wat::f64::/ 0.0 0.0) 1)) ; -> false
(:wat::core::defn :probe::row5-le [] -> :wat::core::bool (:wat::core::<= (:wat::f64::/ 0.0 0.0) 1)) ; -> false (was true)
(:wat::core::defn :probe::row5-gt [] -> :wat::core::bool (:wat::core::> (:wat::f64::/ 0.0 0.0) 1)) ; -> false
(:wat::core::defn :probe::row5-ge [] -> :wat::core::bool (:wat::core::>= (:wat::f64::/ 0.0 0.0) 1)) ; -> false (was true)

;; row 6 — NaN vs NaN.
(:wat::core::defn :probe::row6-lt [] -> :wat::core::bool (:wat::core::< (:wat::f64::/ 0.0 0.0) (:wat::f64::/ 0.0 0.0))) ; -> false
(:wat::core::defn :probe::row6-le [] -> :wat::core::bool (:wat::core::<= (:wat::f64::/ 0.0 0.0) (:wat::f64::/ 0.0 0.0))) ; -> false (was true)
...
(:wat::core::defn :probe::row7-noteq [] -> :wat::core::bool (:wat::core::not= 1 (:wat::f64::/ 0.0 0.0))) ; -> true
(:wat::core::defn :probe::row7-eq [] -> :wat::core::bool (:wat::core::= 1 (:wat::f64::/ 0.0 0.0))) ; -> false

;; row 8 — +/-inf unchanged.
(:wat::core::defn :probe::row8-lt-inf [] -> :wat::core::bool (:wat::core::< 1 (:wat::f64::/ 1.0 0.0))) ; -> true
(:wat::core::defn :probe::row8-le-inf [] -> :wat::core::bool (:wat::core::<= 1 (:wat::f64::/ 1.0 0.0))) ; -> true
...
(:wat::core::defn :probe::row11-f64-lt [] -> :wat::core::bool (:wat::f64::< 1.0 (:wat::f64::/ 0.0 0.0))) ; -> false
(:wat::core::defn :probe::row11-f64-le [] -> :wat::core::bool (:wat::f64::<= 1.0 (:wat::f64::/ 0.0 0.0))) ; -> false
(:wat::core::defn :probe::row11-f64-gt [] -> :wat::core::bool (:wat::f64::> 1.0 (:wat::f64::/ 0.0 0.0))) ; -> false
(:wat::core::defn :probe::row11-f64-ge [] -> :wat::core::bool (:wat::f64::>= 1.0 (:wat::f64::/ 0.0 0.0))) ; -> false
