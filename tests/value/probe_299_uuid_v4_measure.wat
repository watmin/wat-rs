...
(:wat::core::defn :probe::measure [s <- :wat::core::String] -> :wat::core::bool
  (:wat::core::match (:wat::core::Uuid/from-string s) -> :wat::core::bool
    ((:wat::core::Some u) (:wat::core::and (:wat::core::= (:wat::core::Uuid/version u) 4)
                                            (:wat::core::Uuid/rfc4122-variant? u)))
    (:wat::core::None false)))
