...
fn pascal_kebab_both_directions_and_roundtrip() {
    assert_eq!(s(CONV, r#"(:user::p2k "GetObject")"#), "get-object");
    assert_eq!(s(CONV, r#"(:user::p2k "Get")"#), "get");
    assert_eq!(s(CONV, r#"(:user::up "abc")"#), "ABC");
    assert_eq!(s(CONV, r#"(:user::k2p "get-object")"#), "GetObject");
    // bijection on the disciplined subset (one capital per word)
    assert_eq!(s(CONV, r#"(:user::roundtrip "GetObject")"#), "GetObject");
}
