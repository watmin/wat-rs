...
//! their field types in `RecordDef.field_types` — but `:wat::Record::def` emits the
...
//!
//! This is strike 1 of the base-struct unification (R2): make `:wat::Record::def` +
//! `:wat::holon::Record::def` emit the TYPED `recordtype` form so `field_types = Some`, and
...
/// A CORE record (`:wat::Record::def`) that HAS the surface's members satisfies it
...
fn core_record_structurally_satisfies_a_defsurface() {
    let src = r#"
        ...
        (:wat::Record::def :geo::Circle [color <- :wat::core::String  radius <- :wat::core::f64])
...
/// THE R2 HEADLINE: a HOLON record (`:wat::holon::Record::def`) satisfies a core surface —
...
fn holon_record_structurally_satisfies_a_core_surface() {
    let src = r#"
        (:wat::core::defsurface :geo::Shape [color <- :wat::core::String])
        (:wat::holon::Record::def :geo::HCircle [color <- :wat::core::String  radius <- :wat::core::f64])
        (:wat::core::defn :geo::describe [s <- :geo::Shape] -> :wat::core::String
          "ok")
        (:wat::core::defn :user::main [] -> :wat::core::String
...
fn record_missing_a_surface_member_is_rejected() {
    let src = r#"
        (:wat::core::defsurface :geo::Shape [color <- :wat::core::String])
        (:wat::Record::def :geo::Bare [other <- :wat::core::i64])
        (:wat::core::defn :geo::describe [s <- :geo::Shape] -> :wat::core::String
          "ok")
        (:wat::core::defn :user::main [] -> :wat::core::String
