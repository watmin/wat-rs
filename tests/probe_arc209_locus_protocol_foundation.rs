...
;; Post-β-1/β-2: launch MINTS its own listener internally and takes [self state0 serve service-forms]
;; → Launched<S,R> (the thread arm ignores service-forms — serve is in the parent universe). state0=0;
;; service-forms is an empty (forms) for this wiring proof.
(:wat::core::defn :user::start-it [h <- :wat::spawn::Locus] -> :wat::spawn::Launched<wat::core::i64,wat::core::i64>
  (:wat::spawn::Locus/launch h 0 (:wat::core::keyword/from-string "my::svc::serve") (:wat::core::forms)))
