...
(:wat::core::defn :t::test1-result-simple [] -> :wat::core::i64
  (:wat::core::let
    [wrapped   (:wat::core::Ok 42)
     extracted (:wat::core::match wrapped -> :wat::core::i64
                 ((:wat::core::Ok n) (:wat::core::i64::+ n 1))
                 ((:wat::core::Err _) -1))]
    extracted))

;; test2: Result<(i64,i64),i64> — tuple payload → returns i64 11
(:wat::core::defn :t::wrap-it [] -> :wat::core::Result<(wat::core::i64,wat::core::i64),wat::core::i64>
...
(:wat::core::defn :t::test4-operator-lt-ge [] -> :wat::core::bool
  (:wat::core::if (:wat::core::< 1 2) -> :wat::core::bool
    (:wat::core::>= 5 5)
    false))
