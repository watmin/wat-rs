...
(:wat::core::defn :t::test1-worked [] -> :wat::core::bool
  (:wat::core::let [p (:test::PaperResolved/new "Grace" 7.5)]
    (:wat::form::matches? p
      (:test::PaperResolved
        (= ?outcome :outcome)
...
(:wat::core::defn :t::test2-low-residue [] -> :wat::core::bool
  (:wat::core::let [p (:test::PaperResolved/new "Grace" 3.0)]
    (:wat::form::matches? p
      (:test::PaperResolved
        (= ?outcome :outcome)
        (= ?grace-residue :grace-residue)
...
(:wat::core::defn :t::test3-wrong-outcome [] -> :wat::core::bool
  (:wat::core::let [p (:test::PaperResolved/new "Loss" 7.5)]
    (:wat::form::matches? p
      (:test::PaperResolved
        (= ?outcome :outcome)
        (= ?grace-residue :grace-residue)
...
(:wat::core::defn :t::test5-not-eq [] -> :wat::core::bool
  (:wat::core::let [p (:test::PaperResolved/new "Loss" 1.0)]
    (:wat::form::matches? p
      (:test::PaperResolved
        (= ?o :outcome)
        (:not= ?o "Grace")))))
...
(:wat::core::defn :t::test6-and-pass [] -> :wat::core::bool
  (:wat::core::let [p (:test::PaperResolved/new "Grace" 7.0)]
...
(:wat::core::defn :t::test6-and-fail-outcome [] -> :wat::core::bool
  (:wat::core::let [p (:test::PaperResolved/new "Loss" 7.0)]
    (:wat::form::matches? p (:test::PaperResolved
      (= ?o :outcome) (= ?gr :grace-residue)
      (:and (= ?o "Grace") (> ?gr 5.0))))))
...
(:wat::core::defn :t::test7-or-high [] -> :wat::core::bool
  (:wat::core::let [p (:test::PaperResolved/new "Grace" 150.0)]
    (:wat::form::matches? p (:test::PaperResolved
      (= ?gr :grace-residue)
      (:or (> ?gr 100.0) (< ?gr 5.0))))))
(:wat::core::defn :t::test7-or-mid [] -> :wat::core::bool
  (:wat::core::let [p (:test::PaperResolved/new "Grace" 50.0)]
    (:wat::form::matches? p (:test::PaperResolved
      (= ?gr :grace-residue)
      (:or (> ?gr 100.0) (< ?gr 5.0))))))
...
(:wat::core::defn :t::test11-struct-mismatch [] -> :wat::core::bool
  (:wat::core::let [o (:test::Other/new 42)]
    (:wat::form::matches? o
      (:test::PaperResolved
        (= ?gr :grace-residue)
        (> ?gr 5.0)))))
...
(:wat::core::defn :t::test15-binding-where [] -> :wat::core::bool
  (:wat::core::let [p (:test::PaperResolved/new "Grace" 12.5)]
    (:wat::form::matches? p
      (:test::PaperResolved
        (= ?o :outcome)
        (= ?gr :grace-residue)
