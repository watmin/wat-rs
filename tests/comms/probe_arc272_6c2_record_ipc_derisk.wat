              ...
              (:wat::core::defn :user::main [] -> :wat::core::nil
                (:wat::core::let
                  ...
                  [self (:wat::program::self-peer :user::Pt :wat::core::i64)
                   _    (:wat::core::match (:wat::kernel::send self (:user::Pt :x 7 :y 35)) [:wat::kernel::SendOutcome::Sent {} nil] [:wat::kernel::SendOutcome::Closed {} nil] [:wat::kernel::SendOutcome::Lost {:cause _c} nil] [:wat::kernel::SendOutcome::Stopped {} nil])] ;; arc 278 #73 — fire-and-forget record handoff; outcome ignored uniformly regardless of cause
                  nil))))
