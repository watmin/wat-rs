...
;; ServiceEvent is `(ServiceEvent :- [I O A])` — arc 291 3a-i added A (the self-peer's admin receive type).
;; This signature was written when it was `(ServiceEvent :- [I O])` and was never updated, so the body produced
            ...
            (:wat::core::defn :user::main [] -> :wat::core::nil
              (:wat::core::let
                [n (:wat::core::match (:wat::kernel::readln ) [:wat::kernel::ReadlnOutcome::Datum {:v __datum} __datum] [:wat::kernel::ReadlnOutcome::Eof {} (:wat::kernel::assertion-failed! :message "readln: end of input")] [:wat::kernel::ReadlnOutcome::Stopped {} (:wat::kernel::assertion-failed! :message "readln: stop requested")])
                 _ (:wat::kernel::println (:wat::i64::+ n 1))]
                nil))))
     _ (:wat::core::match (:wat::kernel::send b 98) [:wat::kernel::SendOutcome::Sent {} nil] [:wat::kernel::SendOutcome::Closed {} nil] [:wat::kernel::SendOutcome::Lost {:cause _c} nil] [:wat::kernel::SendOutcome::Stopped {} nil]) ;; arc 278 #73 — fire-and-forget request; outcome ignored uniformly regardless of cause
