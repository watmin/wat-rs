     ...
     [peer (:wat::test::spawn-peer (:wat::spawn::thread)
      ...
      a  (:wat::core::match (:wat::kernel::recv peer)
           ...
           [:wat::kernel::RecvOutcome::Closed {}
             (:wat::kernel::assertion-failed! :message "recv': peer closed before serving item 1")])
      ...
      b  (:wat::core::match (:wat::kernel::recv peer)
           ...
           [:wat::kernel::RecvOutcome::Stopped {}
             (:wat::kernel::assertion-failed! :message "recv': stopped — the substrate was asked to stop; the peer was ALIVE and the channel open")]
           [:wat::kernel::RecvOutcome::Closed {}
             (:wat::kernel::assertion-failed! :message "recv': peer closed before serving item 2")])
      ...
      c  (:wat::core::match (:wat::kernel::recv peer)
           ...
           [:wat::kernel::RecvOutcome::Stopped {}
             (:wat::kernel::assertion-failed! :message "recv': stopped — the substrate was asked to stop; the peer was ALIVE and the channel open")]
           [:wat::kernel::RecvOutcome::Closed {}
             (:wat::kernel::assertion-failed! :message "recv': peer closed before serving item 3")])]
