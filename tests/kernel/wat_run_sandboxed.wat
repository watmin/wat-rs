...
(:wat::core::defn :my::compute-single-line [] -> :wat::core::String
  (:wat::core::let
    ...
    (:wat::core::match (:wat::kernel::recv p)
      ...
      (:wat::kernel::RecvOutcome::Closed "UNEXPECTED-CLOSED") (:wat::kernel::RecvOutcome::TimedOut "UNEXPECTED-LOST") ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None)))))
  ...
  (:wat::core::let
    [p (:wat::test::spawn-peer (:wat::spawn::process)
     ...
     r1 (:wat::core::match (:wat::kernel::recv p)
          ...
          (:wat::kernel::RecvOutcome::Closed "UNEXPECTED-CLOSED-1") (:wat::kernel::RecvOutcome::TimedOut "UNEXPECTED-LOST-1") ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None)))
     r2 (:wat::core::match (:wat::kernel::recv p)
          ...
          (:wat::kernel::RecvOutcome::Closed "UNEXPECTED-CLOSED-2") (:wat::kernel::RecvOutcome::TimedOut "UNEXPECTED-LOST-2") ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None)))
     r3 (:wat::core::match (:wat::kernel::recv p)
          ...
          (:wat::kernel::RecvOutcome::Closed "UNEXPECTED-CLOSED-3") (:wat::kernel::RecvOutcome::TimedOut (:wat::kernel::assertion-failed! "recv: timed out — the peer is alive and silent" :wat::core::None :wat::core::None)) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None)))]
    [r1 r2 r3]))
    ...
    (:wat::core::match (:wat::kernel::recv p)
      ...
      ((:wat::kernel::RecvOutcome::Lost cause)
        (:wat::core::match cause
          ...
          (_ "LOST-NON-PANIC")))
      (:wat::kernel::RecvOutcome::Stopped "UNEXPECTED-STOPPED")
      (:wat::kernel::RecvOutcome::Closed "UNEXPECTED-CLOSED") (:wat::kernel::RecvOutcome::TimedOut (:wat::kernel::assertion-failed! "recv: timed out — the peer is alive and silent" :wat::core::None :wat::core::None)) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None)))))
     ...
     r2 (:wat::core::match (:wat::kernel::recv p)
          ...
          ((:wat::kernel::RecvOutcome::Lost cause)
            (:wat::core::match cause
              ...
              (_ "LOST-NON-PANIC-2")))
          (:wat::kernel::RecvOutcome::Stopped "UNEXPECTED-STOPPED-2")
          (:wat::kernel::RecvOutcome::Closed "UNEXPECTED-CLOSED-2") (:wat::kernel::RecvOutcome::TimedOut (:wat::kernel::assertion-failed! "recv: timed out — the peer is alive and silent" :wat::core::None :wat::core::None)) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None)))]
    [r1 r2]))
