...
(:wat::core::defn :user::probe-02 [] -> :wat::core::bool (:my::is-Circle? (:my::Circle :radius 1.0)))

;; ─── Probe 03: is-X? cross-class false ───────────────────────────────────────
(:wat::core::defn :user::probe-03 [] -> :wat::core::bool (:my::is-Circle? (:my::Square :side 2.0)))
...
(:wat::core::defn :user::probe-05 [] -> :wat::core::f64 (:my::Circle/radius (:my::Circle :radius 1.0)))
