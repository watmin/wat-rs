...
(:wat::core::defn :probe::via-process [] -> (:wat::spawn::Launched :- [:wat::core::i64 :wat::core::i64 :wat::core::i64 :wat::core::i64 :wat::kernel::Wire])
  (:probe::launch (:wat::spawn::process)))
(:wat::core::defn :probe::via-thread [] -> (:wat::spawn::Launched :- [:wat::core::i64 :wat::core::i64 :wat::core::i64 :wat::core::i64 :wat::kernel::Shared])
