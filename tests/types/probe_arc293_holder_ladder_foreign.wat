...
;;
;; The foreign half of the nature ladder. A foreign type satisfies a surface via its `extend-type`
;; subtype edge (assignable arms at check.rs:14633/14641) — and that edge must ALSO honor a nature
;; bound: the foreign type's DERIVED nature (is_holon_or_vector -> HolonRecord, is_portable_type ->
...
;; `:nature :wat::holon::Record` surface — even though extend-type supplies the method structurally.
;;
