...
(:wat::core::defn :user::probe-03 [] -> :wat::core::bool (:wat::core::subtype? :my::Circle :wat::Record))

;; ─── Probe 04: directional (Record is NOT-a Circle) ──────────────────────────
(:wat::core::defn :user::probe-04 [] -> :wat::core::bool (:wat::core::subtype? :wat::Record :my::Circle))

;; ─── Probe 05: holon-flavor parent + transitive ──────────────────────────────
(:wat::core::defn :user::probe-05a [] -> :wat::core::bool (:wat::core::subtype? :my::Sphere :wat::Record))
