...
(:wat::core::defn :user::fire-unbound [] -> :wat::core::i64
  (:wat::core::let [rules (:wat::rete::collect-rules :ubs)
                    s0    (:wat::core::match (:wat::rete::compile-all rules (:wat::core::PersistentVector (:ubs::q))) ((:wat::rete::CompileOutcome::Compiled __session) __session) ((:wat::rete::CompileOutcome::MayNotTerminate __rule __fact-type) (:wat::kernel::assertion-failed! "compile: the rule set may not terminate" :wat::core::None :wat::core::None)))
                    s1    (:wat::core::match (:wat::rete::insert-all s0 (:wat::core::PersistentVector (:ubs::Item :k 1))) ((:wat::rete::InsertOutcome::Inserted __staged) __staged) ((:wat::rete::InsertOutcome::MemoryCeilingExceeded __limit __used __count) (:wat::kernel::assertion-failed! "insert: session memory ceiling exceeded while staging" :wat::core::None :wat::core::None)))
