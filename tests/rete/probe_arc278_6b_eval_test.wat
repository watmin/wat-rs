...
(:wat::core::defn :user::comparison-true [] -> :wat::core::bool
  (:wat::rete::eval-test
    ...
    (:wat::core::PersistentMap/assoc (:wat::core::PersistentMap/assoc (:wat::core::PersistentMap) "?a" 5) "?b" 3)))

;; 2 — a false comparison over bindings → false.
(:wat::core::defn :user::comparison-false [] -> :wat::core::bool
  (:wat::rete::eval-test
    (:wat::core::quote (:wat::core::> ?a ?b))
    (:wat::core::PersistentMap/assoc (:wat::core::PersistentMap/assoc (:wat::core::PersistentMap) "?a" 3) "?b" 5)))
...
(:wat::core::defn :user::computed-operand-true [] -> :wat::core::bool
  (:wat::rete::eval-test
    ...
    (:wat::core::PersistentMap/assoc (:wat::core::PersistentMap/assoc (:wat::core::PersistentMap) "?hi" 20) "?lo" 5)))

;; 5 — the same computed operand, false branch.
(:wat::core::defn :user::computed-operand-false [] -> :wat::core::bool
  (:wat::rete::eval-test
    (:wat::core::quote (:wat::core::> (:wat::core::- ?hi ?lo) 10))
    (:wat::core::PersistentMap/assoc (:wat::core::PersistentMap/assoc (:wat::core::PersistentMap) "?hi" 12) "?lo" 5)))
...
(:wat::core::defn :user::user-fn-predicate [] -> :wat::core::bool
  (:wat::rete::eval-test
    ...
    (:wat::core::PersistentMap/assoc (:wat::core::PersistentMap) "?x" 150)))
...
(:wat::core::defn :user::non-bool-result-is-error [] -> :wat::core::bool
  (:wat::rete::eval-test
    (:wat::core::quote (:wat::core::+ ?a ?b))
    (:wat::core::PersistentMap/assoc (:wat::core::PersistentMap/assoc (:wat::core::PersistentMap) "?a" 1) "?b" 2)))
