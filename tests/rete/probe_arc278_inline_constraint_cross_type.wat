...
;;
;; `(:wat::rete::core::i64::> :location 10)` sits inside a fact pattern, where `classify_rete_clause`
...
;;
;; MUST BE REFUSED at COMPILE time — :location is String, the row takes i64.
