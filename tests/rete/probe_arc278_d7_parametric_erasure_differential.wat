  ...
  (:wat::core::let
    [session (:wat::core::match (:wat::rete::compile-all
     ...
     oracle (:wat::core::match (:wat::rete::fire-rules$oracle staged)
               [:wat::rete::FireOutcome.Fired {:value __f} __f]
               [:wat::rete::FireOutcome.MemoryCeilingExceeded {:limit __l :used __u :rounds __r}
                 (:wat::kernel::assertion-failed! :message "oracle ceiling")]
               [:wat::rete::FireOutcome.RoundCapExceeded {:cap __c :still-deriving __s}
                 (:wat::kernel::assertion-failed! :message "oracle cap")])]
    (:wat::string::concat
      (:wat::string::concat
        (:wat::string::concat
          (:wat::string::concat "hitN=" (:d7g::hit-keys native))
          (:wat::string::concat " hitO=" (:d7g::hit-keys oracle)))
        (:wat::string::concat
          (:wat::string::concat " plainN=" (:d7g::plain-keys native))
          (:wat::string::concat " plainO=" (:d7g::plain-keys oracle))))
      (:wat::string::concat
        (:wat::string::concat " pairN=" (:d7g::pair-keys native))
        (:wat::string::concat " pairO=" (:d7g::pair-keys oracle))))))
