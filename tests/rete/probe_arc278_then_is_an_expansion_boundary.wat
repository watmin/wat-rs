...
(:wat::core::defn :teb::fired [n <- :wat::core::String] -> :wat::rete::Session
  (:wat::core::match (:wat::rete::fire-rules
    (:wat::rete::insert-all
      ...
      (:wat::core::PersistentVector (:teb::In :n n)))) [:wat::rete::FireOutcome.Fired {:value __fired} __fired] [:wat::rete::FireOutcome.MemoryCeilingExceeded {:limit __limit :used __used :rounds __rounds} (:wat::kernel::assertion-failed! :message "fire-rules: session memory ceiling exceeded")] [:wat::rete::FireOutcome.RoundCapExceeded {:cap __cap :still-deriving __still} (:wat::kernel::assertion-failed! :message "fire-rules: fixpoint round cap exceeded")]))
