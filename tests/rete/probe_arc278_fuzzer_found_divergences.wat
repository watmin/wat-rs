...
(:wat::core::defn :user::two
  ...
  (:wat::core::let [s0 (:wat::rete::compile-all rules (:wat::core::PersistentVector q))
                    ...
                    st (:wat::core::match (:wat::rete::insert-all s2 (:wat::core::PersistentVector (:user::S1 1))) [:wat::rete::InsertOutcome.Inserted {:session __staged} __staged] [:wat::rete::InsertOutcome.MemoryCeilingExceeded {:limit __limit :used __used :staged __count} (:wat::kernel::assertion-failed! :message "insert: session memory ceiling exceeded while staging")])
...
(:wat::core::defn :user::rows-c [] -> (:wat::core::Vector :- [:wat::core::i64])
  (:wat::core::let [both (:wat::core::PersistentVector (:user::qC) (:user::qS2))
                    ...
                    t0 (:wat::core::match (:wat::rete::insert-all n0 (:wat::core::PersistentVector (:user::S1 1))) [:wat::rete::InsertOutcome.Inserted {:session __staged} __staged] [:wat::rete::InsertOutcome.MemoryCeilingExceeded {:limit __limit :used __used :staged __count} (:wat::kernel::assertion-failed! :message "insert: session memory ceiling exceeded while staging")])
