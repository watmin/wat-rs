      ...
      (:wat::rete::query
        (:wat::rete::fire-rules
          (:wat::rete::insert
            ...
            (:tl::Wide :f0 true :f1 true :f2 true :f3 true :f4 true :f5 true :f6 true :f7 true :f8 true :f9 true :f10 true :f11 true :f12 true :f13 true :f14 true :f15 true :f16 true :f17 true :f18 true :f19 true)))
        (:tl::q)))))
