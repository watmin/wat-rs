;; Co-located fixture for probe_arc301_reput_differential.rs — arc 301 stone 2c.
;;
;; Promoted from docs/arc/2026/08/301-sns-sqs/PROBE-reput-divergence.wat with the
