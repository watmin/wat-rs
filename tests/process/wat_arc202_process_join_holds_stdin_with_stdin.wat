...
(:wat::core::defn :my::arc202::negative-stdin-present [proc <- :wat::kernel::Process<wat::core::nil,wat::core::nil>] -> :wat::core::Result<wat::core::nil,wat::core::Vector<wat::kernel::LociDiedError>>
  (:wat::core::let
