...
(:wat::core::defn :user::compute [] -> :wat::core::String
  (:wat::core::let [peer (:wat::test::spawn-peer (:wat::spawn::process)
                    ...
                    _ (:wat::core::match (:wat::kernel::send peer 0) [:wat::kernel::SendOutcome.Sent {} nil] [:wat::kernel::SendOutcome.HandleClosed {} nil] [:wat::kernel::SendOutcome.Stopped {} nil] [:wat::kernel::SendOutcome.Closed {:cause _c} nil] [:wat::kernel::SendOutcome.Failed {:cause _c} nil])]
