    ...
    let got = eval_i64(
        ...
        "(:wat::time::epoch-millis \
           (:wat::program::Env/wat.started-at \
             (:wat::program::Env (:wat::time::at-millis 5000) (:wat::time::at-millis 0) 0 0 :wat::program::PeerKind::process 1 (:wat::program::EmptyEnv))))",
    );
...
fn c02_user_extends_program_env() {
    ...
    let got = eval_i64(
        ...
        "(:user::MyEnv/port \
           (:user::MyEnv (:wat::time::at-millis 1) (:wat::time::at-millis 0) 0 0 :wat::program::PeerKind::process 1 (:wat::program::EmptyEnv) 8080))",
    );
