(:wat::core::defmacro :user::mk [base <- :wat::WatAST] -> :wat::WatAST
  (:wat::core::let
    ...
    (:wat::core::first (:wat::core::ast->children
      (:wat::core::match (:wat::core::read-string (:wat::core::string::concat "\"" (:wat::core::string::concat full "\""))) ((:wat::core::ReadOutcome::Forms __forms) __forms) ((:wat::core::ReadOutcome::Malformed __cause) (:wat::core::macro-error (:wat::core::string::concat "expand-time read-string failed: " (:wat::core::Error/message __cause)))))))))
