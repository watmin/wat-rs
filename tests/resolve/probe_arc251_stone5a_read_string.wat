(:wat::core::defn :user::c01 [] -> :wat::core::bool
  (:wat::core::List? (:wat::core::match (:wat::core::read-string "(:wat::core::i64::+ 1 2)") [:wat::core::ReadOutcome::Forms {:forms __forms} __forms] [:wat::core::ReadOutcome::Malformed {:cause __cause} (:wat::kernel::assertion-failed! (:wat::core::Error/message __cause) :wat::core::None :wat::core::None)])))
