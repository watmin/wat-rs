...
(:wat::core::defn :user::c03 [] -> :wat::core::String
  (:wat::core::write-forms (:wat::core::keyword/to-type-form (:wat::core::keyword-node ":wat::core::Vector<wat::core::Vector<wat::core::i64>>"))))
(:wat::core::defn :user::c04 [] -> :wat::core::String
  (:wat::core::write-forms (:wat::core::keyword/to-type-form (:wat::core::keyword-node ":wat::core::Vector<T>"))))
(:wat::core::defn :user::c05 [] -> :wat::core::String
  (:wat::core::write-forms (:wat::core::keyword/to-type-form (:wat::core::keyword-node ":wat::core::HashMap<wat::core::String,wat::core::i64>"))))
(:wat::core::defn :user::c06 [] -> :wat::core::String
  (:wat::core::write-forms (:wat::core::keyword/to-type-form (:wat::core::keyword-node ":(wat::core::i64,wat::core::String)"))))
(:wat::core::defn :user::c07 [] -> :wat::core::String
  (:wat::core::write-forms (:wat::core::keyword/to-type-form (:wat::core::keyword-node ":()"))))
(:wat::core::defn :user::c08 [] -> :wat::core::String
  (:wat::core::write-forms (:wat::core::keyword/to-type-form (:wat::core::keyword-node ":(wat::core::Vector<T>,wat::core::i64)"))))
