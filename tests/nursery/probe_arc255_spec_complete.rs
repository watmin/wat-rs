...
fn eval_expr(expr: &str) -> Value {
    let nil_main = "(:wat::core::defn :user::main [] -> :wat::core::nil nil)";
...
/// Run a full-program expression via a :user::compute defn, returning the i64 result.
fn run_program_i64(src: &str) -> i64 {
