...
fn probe_1_map_literal_single_entry() {
    match call_beside_value(file!(), ":t::probe1-map-single").expect("eval") {
...
fn probe_2_map_literal_multi_entry() {
    match call_beside_value(file!(), ":t::probe2-map-multi").expect("eval") {
...
fn probe_3_set_literal_contains() {
    match call_beside_value(file!(), ":t::probe3-set-contains").expect("eval") {
