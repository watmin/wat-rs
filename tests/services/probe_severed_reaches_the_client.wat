...
(:wat::service::defservice :sev::echo
  ...
  :impls
  [(ping [s ctx req] (:wat::service::Outcome::Continue s (:wat::core::Some (:sev::Echo::Reply::Ping (:sev::Echo::PingResponse::Pong))) (:wat::core::Vector :- [(:wat::service::Directed :- [:sev::Echo::Reply])]) (:wat::core::Vector :- [(:wat::service::Alarm :- [:sev::echo::Op])])))])
...
(:wat::core::defn :sev::ping-outcome
  ...
  (:wat::core::match (:sev::Echo/ping c (:sev::Echo::PingRequest))
    ...
    (:wat::kernel::RecvOutcome::Closed "CLOSED:MUTE") (:wat::kernel::RecvOutcome::TimedOut (:wat::kernel::assertion-failed! "recv: timed out — the peer is alive and silent" :wat::core::None :wat::core::None)) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None))))
