      ...
      (:wat::core::let
        [jh    (:probe::script-journal/start :locus (:wat::spawn::thread)
         ...
         ok?     (:wat::core::match recv
                   ...
                   (:wat::kernel::RecvOutcome::Closed 0) (:wat::kernel::RecvOutcome::TimedOut 0) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None)))
         got (:probe::stored-count journal)]
