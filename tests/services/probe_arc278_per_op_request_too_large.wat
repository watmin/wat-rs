...
(:wat::core::defn :user::over-op-returns-matchable [] -> :wat::core::i64
  (:wat::core::let
    ...
    (:wat::core::match r
      ...
      (:wat::kernel::RecvOutcome::Closed -3) (:wat::kernel::RecvOutcome::TimedOut -2) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None)))))
