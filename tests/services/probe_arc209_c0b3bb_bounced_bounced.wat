...
(:wat::core::defn :user::compute [] -> :probe::Outcome
  (:wat::core::let
    [svc     (:wat::test::spawn-peer (:wat::spawn::process)
                  ...
                  (:wat::core::defn :user::main [] -> :wat::core::nil
                    (:wat::core::let
                      ...
                      [self (:wat::program::self-peer
                       ...
                       _    (:wat::core::match (:wat::kernel::send c 7) [:wat::kernel::SendOutcome.Sent {} nil] [:wat::kernel::SendOutcome.HandleClosed {} nil] [:wat::kernel::SendOutcome.Stopped {} nil] [:wat::kernel::SendOutcome.Closed {:cause _c} nil] [:wat::kernel::SendOutcome.Failed {:cause _c} nil])
     ...
     _   (:wat::core::match (:wat::kernel::send stranger svc-addr) [:wat::kernel::SendOutcome.Sent {} nil] [:wat::kernel::SendOutcome.HandleClosed {} nil] [:wat::kernel::SendOutcome.Stopped {} nil] [:wat::kernel::SendOutcome.Closed {:cause _c} nil] [:wat::kernel::SendOutcome.Failed {:cause _c} nil])  ;; arc 278 #73 — the recv' below already faces the stop
