...
(:wat::core::defn :probe::inc
  ...
  (:wat::core::match (:probe::Counter/increment counter (:probe::Counter::IncrementRequest :n 1))
    ...
    (:wat::kernel::RecvOutcome::Closed
      (:wat::kernel::assertion-failed! "inc: closed" :wat::core::None :wat::core::None)) (:wat::kernel::RecvOutcome::TimedOut (:wat::kernel::assertion-failed! "recv: timed out — the peer is alive and silent" :wat::core::None :wat::core::None)) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None))))
...
(:wat::core::defn :probe::read
  ...
  (:wat::core::let
    ...
    (:wat::core::match (:probe::Counter/get c (:probe::Counter::GetRequest))
      ...
      (:wat::kernel::RecvOutcome::Closed
        (:wat::kernel::assertion-failed! "read: closed" :wat::core::None :wat::core::None)) (:wat::kernel::RecvOutcome::TimedOut (:wat::kernel::assertion-failed! "recv: timed out — the peer is alive and silent" :wat::core::None :wat::core::None)) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None)))))
     ...
     _ (:wat::core::mapv
          (:wat::core::fn [i <- :wat::core::i64] -> :wat::core::i64
            (:wat::core::match (:probe::Counter/increment c (:probe::Counter::IncrementRequest :n 1))
              ...
              (:wat::kernel::RecvOutcome::Closed i) (:wat::kernel::RecvOutcome::TimedOut i) ((:wat::kernel::RecvOutcome::Malformed _cause) (:wat::kernel::assertion-failed! "recv: malformed frame — the peer could not decode our message; this arm is an UNMIGRATED PLACEHOLDER (a-momentary-failure-is-not-fatal, stone 2 replaces it with report-final)" :wat::core::None :wat::core::None))))
