...
(:wat::core::defn :probe::run [] -> :wat::core::Vector<wat::core::String>
  (:wat::core::let
    [h1 (:probe::s1'/start :locus (:wat::spawn::process) :record (:probe::s1'::Record))
     ...
     ;; Strike 1a's checker — the gate AND the record-assembly are ONE act. Kwargs are ORDER-FREE
     ;; (scrambled here on purpose); the checker reorders to field order and returns ::Coords.
     coords (:probe::enrich::kwargs-check
              :d2 "D2" :s3 (:wat::capability::Dialable/coord h3) :s1 (:wat::capability::Dialable/coord h1)
              :d5 "D5" :s7 (:wat::capability::Dialable/coord h7) :d1 "D1"
              :s2 (:wat::capability::Dialable/coord h2) :s5 (:wat::capability::Dialable/coord h5)
              :d4 "D4" :s4 (:wat::capability::Dialable/coord h4) :d3 "D3"
              :s6 (:wat::capability::Dialable/coord h6))]
    (:wat::bracket::uses' (:wat::spawn::process)
      [(:wat::core::Tuple :s1 h1) (:wat::core::Tuple :s2 h2) (:wat::core::Tuple :s3 h3)
       (:wat::core::Tuple :s4 h4) (:wat::core::Tuple :s5 h5) (:wat::core::Tuple :s6 h6)
       (:wat::core::Tuple :s7 h7)]
      ["a" "b"]
      :probe::enrich
      coords)))
