...
(:wat::core::defn :user::compute [] -> :wat::core::i64
  (:wat::core::let
    [sh    (:wat::query::mem-store/start :locus (:wat::spawn::process)
     ...
     m1    (:wat::telemetry::Metric :namespace "probe-ns" :uuid (:wat::core::Uuid/nil) :tags tags
             :time-ns 1000000000 :start-time-ns 0 :name :a
             :value (:wat::telemetry::Numeric::I64 1) :unit :wat::telemetry::Unit::Count)
     m2    (:wat::telemetry::Metric :namespace "probe-ns" :uuid (:wat::core::Uuid/nil) :tags tags
