...
(:wat::core::defn :user::small-foo-survives [] -> :wat::core::i64
  (:wat::core::let
    [big  (:probe::payload-of 400)     ;; > 4096 → over-FOO
     ...
     _    (:wat::core::match (:wat::kernel::send c1 (:probe::Big::Op.Put {:req (:probe::Big::PutRequest :payload big)})) [:wat::kernel::SendOutcome.Sent {} nil] [:wat::kernel::SendOutcome.HandleClosed {} nil] [:wat::kernel::SendOutcome.Stopped {} nil] [:wat::kernel::SendOutcome.Closed {:cause _c} nil] [:wat::kernel::SendOutcome.Failed {:cause _c} nil])
