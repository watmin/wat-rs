...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:wat::core::let
    [h (:wat::core::Result/expect (:wat::cache::Lru/new :- [:wat::core::keyword :wat::core::i64] 2) "handle")
     ...
     cache (:wat::core::Result/expect (:wat::cache::Lru/new :- [(:wat::core::HashMap :- [:wat::core::i64 (:wat::cache::Lru :- [:wat::core::keyword :wat::core::i64])]) :wat::core::i64] 2) "cache")
     ...
     _pop  (:wat::core::match (:wat::cache::Lru/put cache (:wat::core::HashMap :- [:wat::core::i64 (:wat::cache::Lru :- [:wat::core::keyword :wat::core::i64])]) 7)
