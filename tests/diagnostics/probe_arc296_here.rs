...
//!
//! Verifies that `(:wat::kernel::here)` returns a `:wat::core::Span`
...
//!
//! GREEN after: type-checker accepts `[] -> :wat::core::Span`,
...
fn kernel_here_returns_location_with_positive_line() {
    ...
    // Run main — the body asserts Span/line > 0 via (:wat::test::assert-true ...).
