;; Fixture for probe_ex003_hashability_looks_inside.rs (excursus 003, stone E). Key: `(List <handle>)` — direct; the checker admits it.
...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:wat::core::let
    [h (:wat::core::Result/expect (:wat::cache::Lru/new :- [:wat::core::keyword :wat::core::i64] 2) "handle")
     k (:wat::core::List h)
     cache (:wat::core::Result/expect (:wat::cache::Lru/new :- [(:wat::core::List :- [(:wat::cache::Lru :- [:wat::core::keyword :wat::core::i64])]) :wat::core::i64] 2) "cache")
     ...
     _pop  (:wat::core::match (:wat::cache::Lru/put cache (:wat::core::List) 7)
