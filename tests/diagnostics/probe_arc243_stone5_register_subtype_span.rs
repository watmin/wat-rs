...
//! a hardcoded `wat::rust_caller_span!()` baked into the emitter. This is the honesty
...
//!   The emitter at types.rs:451 hardcodes `span: wat::rust_caller_span!()`, so even
...
fn register_subtype_threads_caller_span_into_cyclic_error() {
    ...
    env.register_subtype("a", "b", wat::rust_caller_span!())
