...
;; the shared page-loop, called after the flood has landed — pages `sift-rules` at :limit 100,
;; accumulating the Deductions count and asserting NO Lemma (Suspect/Flagged) ever leaks into the
;; returned items, until the cursor is exhausted.
(:wat::core::defn :arena::page-loop
  [svc <- :wat::kernel::Peer'<arena::my-sift::Op,arena::my-sift::Reply>]
  -> :wat::core::i64
  (:wat::core::let
...
(:wat::core::defn :user::main [] -> :wat::core::nil
  (:wat::kernel::println (:wat::core::string::concat "THREAD: " (:wat::core::str (:user::sift-rules-arena-thread)))))
