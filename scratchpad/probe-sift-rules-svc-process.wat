;; Probe: sift-rules-defsvc end to end on PROCESS locus (loci-agnostic proof). mem-store' <-
;; journal' <- my-sift' (macro-generated), all on process, grant-before-dial at every hop. Write
;; 10 Logs (5 hot usr::Temp c=60, 5 cold c=10); call sift-rules; expect 10 deductions.
