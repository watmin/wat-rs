...
1. `DESIGN.md` — why the defect is in **core**, not the store, and
   the two routes rejected.
2. `BRIEF.md` — the rooms as exact `file:line`, four STOP triggers.
3. `docs/excursus/2026/08/001-sns-sqs/perf-2-store-read-path/SCORE.md` — the stone before this; its Row 3 section is why this brief
