...
Read `DESIGN.md` beside this first — the contract decision is that
...
`docs/excursus/2026/08/001-sns-sqs/perf-2-store-read-path/SCORE.md` — the stone before this, and its Row 3 section is why this brief
