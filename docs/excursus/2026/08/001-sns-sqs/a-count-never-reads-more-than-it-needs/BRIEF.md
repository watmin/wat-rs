...
queue already computes. Read `DESIGN.md` first — especially
...
`docs/excursus/2026/08/001-sns-sqs/a-read-declares-its-page/SCORE.md` — the sibling bound, on rows returned rather than rows
examined.
