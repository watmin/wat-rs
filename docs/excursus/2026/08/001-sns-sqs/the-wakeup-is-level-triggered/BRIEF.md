...
1. **`DESIGN.md`** — the design, the amplification argument, and
   the one contract decision (an explicit `tick-armed?` flag). Read first.
2. **`docs/excursus/2026/08/001-sns-sqs/the-workers-stop-polling/SCORE.md`** — the previous strike. **The scale matrix and the stuck
...
`docs/excursus/2026/08/001-sns-sqs/the-sane-circuit/SCORE.md` for proving a term load-bearing by **removing** it and requiring failure.
`docs/excursus/2026/08/001-sns-sqs/the-workers-stop-polling/SCORE.md` for how a scale matrix with named drivers beats a re-run.
...
Write `SCORE.md` when done. It will be graded by re-running.
