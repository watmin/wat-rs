...
snapped every 500 ms (`docs/excursus/2026/08/001-sns-sqs/the-workers-stop-polling/SCORE.md`):
...
- **Ack batching and the drain poller.** Still cut, still for the numbers in
  `docs/excursus/2026/08/001-sns-sqs/the-workers-stop-polling/DESIGN.md`. Re-measure after this lands.
