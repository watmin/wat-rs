...
Read `DESIGN.md` first — especially the contract decision on what is
...
`docs/excursus/2026/08/001-sns-sqs/the-queue-can-drop-too/SCORE.md` — its grading is where the gate-versus-report rule was written
