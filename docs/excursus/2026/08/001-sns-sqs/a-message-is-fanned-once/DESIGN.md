...
★★ `docs/excursus/2026/08/001-sns-sqs/what-does-publish-actually-cost/SCORE.md` had already ruled it, and I re-derived it wrongly
...
- **Caching `depth` to avoid the per-send `count-index`.** 517 µs × every send is real, but
  `docs/excursus/2026/08/001-sns-sqs/stop-fetching-rows-to-get-a-number/SCORE.md` deleted those counters deliberately. Re-introducing
