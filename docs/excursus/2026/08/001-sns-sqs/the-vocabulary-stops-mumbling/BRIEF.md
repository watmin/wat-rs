...
`0afac6aa2`, tree clean. Read `DESIGN.md` first.
...
Leave your work uncommitted. Prior comparable result: `docs/excursus/2026/08/001-sns-sqs/the-instrument-fits-the-question/SCORE.md`.
