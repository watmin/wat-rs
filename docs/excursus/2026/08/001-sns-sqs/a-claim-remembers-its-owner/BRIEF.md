...
Read `DESIGN.md` first — it carries the evidence and the one
...
`docs/excursus/2026/08/001-sns-sqs/depth-is-read-not-counted/SCORE.md` — same campaign, immediately prior. Note especially how its
