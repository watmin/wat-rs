...
`wat-scripts/fanout/circuit.wat` only. Read `DESIGN.md` first.
...
`docs/excursus/2026/08/001-sns-sqs/the-benchmark-has-more-than-one-publisher/SCORE.md` — the arc's other instrument stone, whose
