...
Read `DESIGN.md` beside this first — two contract decisions, and the second
...
`docs/excursus/2026/08/001-sns-sqs/the-sane-circuit/SCORE.md` — its row 2 is the model for proving a drain term load-bearing, and its
