...
Read `DESIGN.md` first — it carries the four proven probes, the seven carries, and
...
7. **`docs/excursus/2026/08/001-sns-sqs/a-peer-is-dead-only-when-redial-fails/SCORE.md`** — the
...
Leave your work uncommitted. Prior comparable result: `docs/excursus/2026/08/001-sns-sqs/a-peer-is-dead-only-when-redial-fails/SCORE.md`.
