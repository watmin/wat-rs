...
(:wat::core::defsurface :p::Src :nature :wat::kernel::Peer
  ...
  [(:wat::core::defrecord :p::Src::GetRequest [])
   (:wat::core::defenum :p::Src::GetResponse :wat::enum::Pure
     :Ok [items <- (:wat::core::Vector :- [:p::Item])]                                    ;; ← carries the outside type
...
(:wat::service::defservice :p::src
  ...
  :impls [(get [s ctx req] (:wat::service::Outcome::Continue s
                             (:wat::core::Some (:p::Src::Reply::Get (:p::Src::GetResponse::Ok (:wat::core::Vector :- [:p::Item] (:p::Item :id "x"))))) (:wat::core::Vector :- [(:wat::service::Directed :- [:p::Src::Reply])]) (:wat::core::Vector :- [(:wat::service::Alarm :- [:p::src::Op])])))])
       ...
       [r (:p::Src/get (:p::use::State/src s) (:p::Src::GetRequest))
        out (:wat::core::match r
              ((:wat::kernel::RecvOutcome::Message m)
                (:wat::core::match m
                  ((:p::Src::GetResponse::Ok items) (:p::Item/id (:wat::core::first items)))   ;; ★ THE CALL
                  (_ "other")))
              (_ "recv"))]
