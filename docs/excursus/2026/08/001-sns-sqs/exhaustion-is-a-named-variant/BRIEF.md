...
1. **`wat-scripts/scratch-pad/probe-a-local-fn-can-be-generic.wat`** — **read this first, and read
   ...
   retracted claim.
2. **`docs/excursus/2026/08/001-sns-sqs/exhaustion-cannot-be-discarded/SCORE.md`** — why one parametric enum fails: the child
...
`docs/excursus/2026/08/001-sns-sqs/the-ack-retries-like-the-publisher/SCORE.md` — the ack loop it shipped is the exact loop check and
