...
`113bc7e97`. Read `DESIGN.md` first — it carries the evidence and the rejected
...
`docs/excursus/2026/08/001-sns-sqs/the-sane-circuit/SCORE.md` — note especially how its row 2 proved a term load-bearing by *removing*
