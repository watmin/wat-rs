...
`b8f83ae1e`, tree clean. Read `DESIGN.md` first.
...
6. **`docs/excursus/2026/08/001-sns-sqs/the-ledger-counts-what-it-absorbs/SCORE.md`** — why
...
Leave your work uncommitted. Prior comparable result: `docs/excursus/2026/08/001-sns-sqs/the-ledger-counts-what-it-absorbs/SCORE.md`.
