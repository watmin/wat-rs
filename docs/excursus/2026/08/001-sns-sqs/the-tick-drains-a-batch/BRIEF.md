...
1. **`DESIGN.md`** — the numbers and the one contract decision (K is
...
4. **`docs/excursus/2026/08/001-sns-sqs/the-sane-circuit/SCORE.md` row 5** — "the worker is interruptible; `Admin::Stop` is taken
...
`docs/excursus/2026/08/001-sns-sqs/the-fanout-is-concurrent/SCORE.md` for reporting per-delivery across N, and for wiring the proof
