...
Read `DESIGN.md` first — it carries the census and the measured
...
`docs/excursus/2026/08/001-sns-sqs/a-ledger-is-a-receipt/SCORE.md` — the immediately prior strike, and its discipline: it reported
