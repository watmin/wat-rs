...
`call-by-deadline`'s `(:wat::program::env)` (`service.wat:3150`). docs/excursus/2026/08/001-sns-sqs/a-client-has-a-deadline/DESIGN.md
...
`docs/excursus/2026/08/001-sns-sqs/every-client-call-has-a-deadline/SCORE.md`, my grading, two stones ago:
