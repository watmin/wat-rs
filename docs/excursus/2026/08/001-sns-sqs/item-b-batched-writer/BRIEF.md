...
Read `DESIGN.md` beside this first. It carries the scope ruling (do **not**
...
`docs/excursus/2026/08/001-sns-sqs/item-c-stone-c-flush-must-speak/SCORE.md` beside this — and read its Row 2 section, which is the
