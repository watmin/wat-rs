...
1. `DESIGN.md` — the scope ruling, the cut rule, the one decision that is a
   data bug in both directions.
2. `BRIEF.md` — the rooms as exact `file:line`, four STOP triggers.
3. `docs/excursus/2026/08/001-sns-sqs/item-c-stone-c-flush-must-speak/SCORE.md` — its Row 2 section is the finding you are closing.
