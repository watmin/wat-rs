...
Read `DESIGN.md` beside this first — the contract decision is that the drain
...
`docs/excursus/2026/08/001-sns-sqs/queue-long-poll/SCORE.md` — where using this fixture as a perf witness produced a measured "loss"
