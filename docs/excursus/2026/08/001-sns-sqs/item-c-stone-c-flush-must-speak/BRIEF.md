...
Read `DESIGN.md` beside this first — it carries the ruling
...
`docs/excursus/2026/08/001-sns-sqs/item-c-stone-b-two-clocks/SCORE.md` beside this. Its Row 8 section records a row of MINE that was
