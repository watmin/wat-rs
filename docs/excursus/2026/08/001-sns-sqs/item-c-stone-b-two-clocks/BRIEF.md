...
Read `DESIGN.md` beside this first: it carries the split's invariant
...
`docs/excursus/2026/08/001-sns-sqs/item-c-stone-a-buffered-span/SCORE.md` beside this — the stone this builds on, and its delta section
