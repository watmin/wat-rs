...
1. `DESIGN.md` — the split's invariant and the arming answer.
2. `BRIEF.md` — the rooms as exact `file:line`, four STOP triggers.
3. `docs/excursus/2026/08/001-sns-sqs/item-c-stone-a-buffered-span/SCORE.md` — the stone you are building on.
