...
- **`Poll`** — `circuit.wat:144` says *"Park, don't poll"*, and
  `docs/excursus/2026/08/001-sns-sqs/the-workers-stop-polling/BRIEF.md:3` defines polling as *"`:wait-ns 0` … producing 144,485
...
`:297 :388 :470 :491 :578 :629` are the *former* `Nanosecond 0` sites (`docs/excursus/2026/08/001-sns-sqs/the-sane-circuit/SCORE.md:53`);
