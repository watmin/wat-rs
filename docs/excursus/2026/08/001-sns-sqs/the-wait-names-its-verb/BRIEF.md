...
Read `DESIGN.md` first — it carries the census, the rejected names, and the
...
Leave your work uncommitted. Prior comparable result for shape: `docs/excursus/2026/08/001-sns-sqs/time-crosses-the-boundary/SCORE.md`.
