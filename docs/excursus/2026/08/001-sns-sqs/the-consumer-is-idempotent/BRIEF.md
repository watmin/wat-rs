...
1. **`DESIGN.md`** — the contract decision (identity is a domain
   fact assigned at publish, not a transport fact minted per send).
2. **`docs/excursus/2026/08/001-sns-sqs/FINDING-durability-is-store-op-bound.md`**, the red-arm section — the actual failure, captured
