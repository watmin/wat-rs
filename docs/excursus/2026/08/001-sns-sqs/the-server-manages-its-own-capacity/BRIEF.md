...
`Queue::send`. Read `DESIGN.md` first — it opens with a ruling
...
`docs/excursus/2026/08/001-sns-sqs/the-topic-publishes-a-batch/SCORE.md` — same files, one stone earlier.
