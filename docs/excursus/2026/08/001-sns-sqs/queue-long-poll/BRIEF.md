...
Read `DESIGN.md` beside this first — the contract decision is that there
...
`docs/excursus/2026/08/001-sns-sqs/deferred-reply/SCORE.md` — the substrate this consumes, and a no-delta stone whose gate had to prove
