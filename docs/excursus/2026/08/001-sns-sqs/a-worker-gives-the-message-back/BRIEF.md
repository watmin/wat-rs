...
Read `DESIGN.md` first — in particular *why the 0/6 is not a fix*.
...
`docs/excursus/2026/08/001-sns-sqs/a-ledger-is-a-receipt/SCORE.md` — the stone that made give-back safe, and the reason exhaustion
