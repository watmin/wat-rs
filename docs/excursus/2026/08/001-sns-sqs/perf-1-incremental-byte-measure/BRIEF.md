...
Read `DESIGN.md` beside this first — the contract decision is
...
`docs/excursus/2026/08/001-sns-sqs/item-b-batched-writer/SCORE.md` — the first no-delta stone, and its note on why: decisions made
