...
Read `DESIGN.md` first. `wat-scripts/scratch-pad/probe-a-ledger-is-a-receipt-not-a-lock.wat`
...
`docs/excursus/2026/08/001-sns-sqs/a-claim-remembers-its-owner/SCORE.md` — the immediately prior NOT-STRUCK. Its discipline is the
