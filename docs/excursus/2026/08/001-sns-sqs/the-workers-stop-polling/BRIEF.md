...
1. **`DESIGN.md`** — the design and the one contract decision
...
6. **`docs/excursus/2026/08/001-sns-sqs/queue-long-poll/SCORE.md:47,57,92`** — why adoption was
...
`docs/excursus/2026/08/001-sns-sqs/the-sane-circuit/SCORE.md` for how a row is proven by **removing** the thing and requiring a
failure. `docs/excursus/2026/08/001-sns-sqs/async-publish/SCORE.md` for how a wall-time regression is reported rather than promised.
