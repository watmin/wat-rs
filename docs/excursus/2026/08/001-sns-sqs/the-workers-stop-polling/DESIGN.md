...
`docs/excursus/2026/08/001-sns-sqs/the-sane-circuit/SCORE.md`). J = 1,2,3,4,5,8 parkers, all at **process** locus, every one provably
...
`docs/excursus/2026/08/001-sns-sqs/queue-long-poll/SCORE.md` withdrew circuit adoption as *"a measured loss"* — and was right **for
