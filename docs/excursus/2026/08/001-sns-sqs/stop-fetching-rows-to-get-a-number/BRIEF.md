...
Read `DESIGN.md` first — including the standing rule that a
...
`docs/excursus/2026/08/001-sns-sqs/depth-is-read-not-counted/SCORE.md` — the stone that introduced this cost, and my grading on it
