...
Read `DESIGN.md` first — it carries the two measurements and the one
contract decision.
...
`docs/excursus/2026/08/001-sns-sqs/a-transaction-that-fails-must-close/SCORE.md` — same arc, same three files, the shape to copy.
