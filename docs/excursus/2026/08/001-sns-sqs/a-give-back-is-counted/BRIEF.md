...
Read `DESIGN.md` first. **The exemplar to copy is `disrupt-hits`** — the
...
`docs/excursus/2026/08/001-sns-sqs/a-worker-gives-the-message-back/SCORE.md` — the stone this makes visible, and my grading on it
