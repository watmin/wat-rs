...
1. **`docs/excursus/2026/08/001-sns-sqs/exhaustion-is-a-named-variant/SCORE.md`** — **your own SCORE, and the GRADING under it.** The
...
`docs/excursus/2026/08/001-sns-sqs/the-ack-retries-like-the-publisher/SCORE.md` — its ack loop is the exact loop check and mark need.
