...
Read `DESIGN.md` first — it carries the census, the mechanism, and
...
Leave your work uncommitted. Prior comparable result for shape: `docs/excursus/2026/08/001-sns-sqs/the-wait-names-its-verb/SCORE.md`.
