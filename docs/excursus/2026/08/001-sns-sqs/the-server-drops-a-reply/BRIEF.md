...
`e57615294`, tree clean. Read `DESIGN.md` first.
...
5. **`docs/excursus/2026/08/001-sns-sqs/chaos-is-a-rate/SCORE.md`** — 3c's shape: rate 0 arms nothing, seed on the Record, replay by
...
Leave your work uncommitted. Prior comparable: `docs/excursus/2026/08/001-sns-sqs/a-client-has-a-deadline/SCORE.md`.
