...
1. **`DESIGN.md`** — the shape, and the one contract decision (a raw
...
`docs/excursus/2026/08/001-sns-sqs/the-circuit-goes-persistent/SCORE.md` for reporting a per-delivery slope rather than a wall time.
