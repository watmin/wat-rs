...
`DESIGN.md` first — especially *the cap interaction* and *stamps are
per message*.
...
`docs/excursus/2026/08/001-sns-sqs/a-batch-declares-how-many/SCORE.md` — same mechanism, one surface earlier.
