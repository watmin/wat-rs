...
`933a084e6`, tree clean. Read `DESIGN.md` first.
...
5. **`wat-scripts/fanout/circuit.wat:1211`** — `:user::chaos` (rate 200 bp, seed 42). Proof row 1
   runs this.
6. **`docs/excursus/2026/08/001-sns-sqs/chaos-is-a-rate/SCORE.md`** — the bound this stone lifts.
...
Leave your work uncommitted. Prior comparable result: `docs/excursus/2026/08/001-sns-sqs/chaos-is-a-rate/SCORE.md`.
