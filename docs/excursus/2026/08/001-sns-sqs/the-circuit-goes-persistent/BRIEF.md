...
1. **`DESIGN.md`** — the numbers, the scope ruling (container
...
`docs/excursus/2026/08/001-sns-sqs/the-wakeup-is-level-triggered/SCORE.md` for a scale matrix with named drivers.
