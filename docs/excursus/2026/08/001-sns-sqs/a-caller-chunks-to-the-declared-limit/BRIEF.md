...
`DESIGN.md` first — it carries the 3.3× measurement and the
...
`docs/excursus/2026/08/001-sns-sqs/a-batch-declares-how-many/SCORE.md` — the stone that built `:max-entries` and its defs.
