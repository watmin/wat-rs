...
`b8a868fca`, tree clean. Read `DESIGN.md` first.
...
Leave your work uncommitted. Prior comparable: `docs/excursus/2026/08/001-sns-sqs/the-vocabulary-stops-mumbling/SCORE.md`.
