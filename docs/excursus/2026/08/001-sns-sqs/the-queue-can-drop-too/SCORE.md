...
`docs/excursus/2026/08/001-sns-sqs/a-ledger-is-a-receipt/DESIGN.md` names as irreducible and which the arc's standing invariant
...
1. `docs/excursus/2026/08/001-sns-sqs/a-claim-remembers-its-owner/BRIEF.md` STOP-3 — `dup=0`, contradicting the tracker's own ruling
2. `docs/excursus/2026/08/001-sns-sqs/a-call-outcome-cannot-lie/EXPECTATIONS.md` row 8 — a publish *band* from one 5-run sample
