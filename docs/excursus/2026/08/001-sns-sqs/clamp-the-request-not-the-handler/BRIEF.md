...
`wat/service.wat` only. Read `DESIGN.md` first.
...
`docs/excursus/2026/08/001-sns-sqs/find-the-934-milliseconds/SCORE.md` — the arc's prior "a shape change cost us time" stone.
