...
Read `DESIGN.md` beside this first — the contract decision (the durable
...
`docs/excursus/2026/08/001-sns-sqs/item-b-batched-writer/SCORE.md` — a no-delta stone whose decisions were made against measurements
