...
1. **`DESIGN.md`** — the stamps, the one contract decision
   (in-band, not via the telemetry service), and why the queue counters are deferred rather than cut.
2. **`docs/excursus/2026/08/001-sns-sqs/FINDING-the-drain-variance.md`** — what is established and what is already ruled out.
...
`docs/excursus/2026/08/001-sns-sqs/the-tick-drains-a-batch/SCORE.md` for reporting a distribution rather than a sample — and note that
