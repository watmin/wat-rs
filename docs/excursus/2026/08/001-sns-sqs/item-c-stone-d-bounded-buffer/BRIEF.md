...
Read `DESIGN.md` beside this first — it carries the three-part contract
...
`docs/excursus/2026/08/001-sns-sqs/item-b-batched-writer/SCORE.md` beside this — the first stone in this campaign with no delta, and
