...
>   - Downstream of 232, also 237-gated: **arc 235** (records-with-rich-VSA — 237's `:guard` per-field-validation consumer; a future *opening*). Banked: 249 (`->>` thread-last, LOW) + the Clojure-naming roadmap (line above).
