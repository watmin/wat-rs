...
## Currently (2026-05-31 — homes-walk CLOSED; recensere minted+PUBLISHED. wat-rs HEAD `1402f114`, 13 commits UNPUSHED on `arc-170-gap-j-v5-deadlock-state` (push = user's call, still pending). Arc 243 conformare still OPEN: 243.4/243.5/243.6 PLANNED.)
