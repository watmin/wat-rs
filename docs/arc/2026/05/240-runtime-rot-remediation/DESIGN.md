...
| **F** | `probe_lifeline_pipe_proof`: orphan-proof failed **1/100 trials** — probabilistic, fork/pidfd. | 1 | arc 213 open | **USER REVIEW** — re-run to confirm flaky; not touched here. |
