...
H-1b    the same for atom.rs                ← NEXT: 60 verbs, on a proven shape
...
| **H-1b** | the same for `atom.rs` | 60 verbs | *not drawn* — copy H-1a's brief | — **UNBLOCKED**, H-1a proved the shape |
