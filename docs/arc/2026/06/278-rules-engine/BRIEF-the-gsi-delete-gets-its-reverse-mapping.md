...
5. **`docs/arc/2026/06/278-rules-engine/SCORE-the-store-reports-time-per-operation.md`** — the per-op
...
**Write the SCORE to
`docs/arc/2026/06/278-rules-engine/SCORE-the-gsi-delete-gets-its-reverse-mapping.md`** in the shape of the
