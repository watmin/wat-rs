...
| 3 | `wat-scripts/perf/grid/` (148 files, 16,616 lines) | **13 cast** | **30** | ⏳ MID-FLIGHT |
...
`probare` (3), `perspicere` (1). `cernere` was cast alongside `perspicere` and is IN FLIGHT at this
writing — if no `reports-target3/cernere.md` exists, its return was lost to the wall and it must be recast. ⭐ **`purgare` LANDED before the wall** (1 row, `3G1`) — it is in `reports-target3/purgare.md`.

**Target 3 — still to cast:** `cernere` (in flight),
