...
| 3 | `wat-scripts/perf/grid/` (148 files, 16,616 lines) | **8 cast** | **19** | ⏳ MID-FLIGHT |
...
`conferre` (2), `intueri` (4, incl. one L1), `struere` (5, incl. one L1). ⭐ **`purgare` LANDED before the wall** (1 row, `3G1`) — it is in `reports-target3/purgare.md`.
