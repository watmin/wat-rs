...
1. **`docs/arc/2026/06/278-rules-engine/DESIGN-the-slope-belongs-to-a-phase.md`** — why `vis` must be
   pinned, why `setup` is measured but not targeted, and what each outcome means.
2. **`docs/arc/2026/06/278-rules-engine/SCORE-vis-is-swept-not-chosen-v2.md`** — the sweep table's shape,
   and the measured fact that `drain ≈ max(work, vis)`.
3. **`docs/arc/2026/06/278-rules-engine/SCORE-the-summary-counts-with-a-set.md`** — the most recent
...
**Write the SCORE to
`docs/arc/2026/06/278-rules-engine/SCORE-the-slope-belongs-to-a-phase.md`** in the shape of the
