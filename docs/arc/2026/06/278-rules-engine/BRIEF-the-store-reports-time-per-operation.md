...
5. **`docs/arc/2026/06/278-rules-engine/SCORE-the-slope-belongs-to-a-phase.md`** — the sweep's shape, its
...
**Write the SCORE to
`docs/arc/2026/06/278-rules-engine/SCORE-the-store-reports-time-per-operation.md`** in the shape of the
