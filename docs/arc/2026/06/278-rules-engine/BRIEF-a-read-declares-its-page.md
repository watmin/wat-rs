...
`DESIGN-a-read-declares-its-page.md` first — it says what this stone does **not** fix.
...
`SCORE-a-caller-chunks-to-the-declared-limit.md` — the write-side sibling, same emission-condition
shape.

Write `SCORE-a-read-declares-its-page.md`, then `pulsare_yield kind=scored`.
