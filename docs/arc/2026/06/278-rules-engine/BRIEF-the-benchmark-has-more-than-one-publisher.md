...
`DESIGN-the-benchmark-has-more-than-one-publisher.md` first — it corrects a grading of mine and
...
`SCORE-the-client-backs-off-intelligently.md` — the stone whose framing this corrects.

Write `SCORE-the-benchmark-has-more-than-one-publisher.md`, then `pulsare_yield kind=scored`.
