...
Read `DESIGN-entry-three-of-ten.md` first — especially the prediction and its mechanism.
...
`SCORE-a-ledger-is-a-receipt.md` — a probe that built a miniature service to isolate a semantic
