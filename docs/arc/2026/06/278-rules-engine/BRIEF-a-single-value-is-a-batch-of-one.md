...
Read `DESIGN-a-single-value-is-a-batch-of-one.md` first — especially *per-entry results only
...
`SCORE-stop-fetching-rows-to-get-a-number.md` — the last perf strike, and its discipline of
