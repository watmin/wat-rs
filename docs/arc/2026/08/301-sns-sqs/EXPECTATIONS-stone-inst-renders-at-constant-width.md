# EXPECTATIONS — arc 301 stone INST
...
| 2 | the probe was not edited | `git diff -- docs/arc/2026/08/301-sns-sqs/PROBE-inst-lexicographic-order-is-not-chronological.wat` | **empty** |
...
| 12 | arc 301 stones undisturbed | `store_delete`, `delete_differential`, `reput_differential` | all still PASS |
