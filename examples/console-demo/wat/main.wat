     ...
     ((_inner :wat::core::nil)
      (:wat::core::let
        (((handle :wat::console::Handle)
         ...
         ((_run-notag-json :wat::core::nil) (:demo::run notag-json-logger))
         ;; ── Pretty (tagged, multi-line) ───────────────────────
         ((_banner-pretty :wat::core::nil)
          (:wat::console::out handle
            "\n=== :Pretty (tagged, multi-line) ===\n"))
