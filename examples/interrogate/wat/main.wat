...
(:wat::core::defn :demo::write-fixture [path <- :String] -> :wat::kernel::Thread<wat::core::nil,wat::core::nil>
  (:wat::core::let
      [spawn
...
;; constraints.
(:wat::core::defn :demo::big-buy? [event <- :wat::telemetry::Event] -> :wat::core::bool
  (:wat::core::match
...
(:wat::core::defn :user::main [_stdin <- :wat::io::IOReader stdout <- :wat::io::IOWriter _stderr <- :wat::io::IOWriter] -> :wat::core::nil
  (:wat::core::let
